...
public partial class Samples_WebCharts_Style_Axis_Visibility_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.CheckBox2.Checked = this.UltraChart1.Axis.Y.Visible;
        }

        this.UltraChart1.Axis.X.Visible = this.CheckBox1.Checked;
        this.UltraChart1.Axis.Y.Visible = this.CheckBox2.Checked;
