<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_Axis_Visibility_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ...
                    <ScatterChart ColumnX="1" CharacterFont="Microsoft Sans Serif, 7.8pt" Icon="Diamond"
            ...
            <td valign="top">
                <div>
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, AxisVisibility_Label1 %>"
                        AutoPostBack="True"></asp:CheckBox>
                </div>
                <div>
                    <asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="True" Text="<%$ Resources:WebCharts, AxisVisibility_Label2 %>">
                    </asp:CheckBox>
                </div>
            </td>
        </tr>
