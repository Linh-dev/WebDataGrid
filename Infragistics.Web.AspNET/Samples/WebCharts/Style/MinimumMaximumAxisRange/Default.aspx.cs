...
public partial class Samples_WebCharts_Style_Minimum_Maximum_Axis_Range_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            string[] axisRangeType = System.Enum.GetNames(typeof(AxisRangeType));
            foreach (string s in axisRangeType)
            {
                this.DropDownList1.Items.Add(s);
            }

            this.DropDownList1.Items.FindByValue(System.Enum.GetName(typeof(AxisRangeType), this.UltraChart1.Axis.Y.RangeType)).Selected = true; ;
            this.WebNumericEdit1.ValueDouble = this.UltraChart1.Axis.Y.RangeMin;
            this.WebNumericEdit2.ValueDouble = this.UltraChart1.Axis.Y.RangeMax;
        }
    }
    ...
    {
        this.UltraChart1.Axis.Y.RangeType = (AxisRangeType)System.Enum.Parse(typeof(AxisRangeType), this.DropDownList1.SelectedItem.Value);
        this.UltraChart1.Axis.Y.RangeMin = this.WebNumericEdit1.ValueDouble;
        this.UltraChart1.Axis.Y.RangeMax = this.WebNumericEdit2.ValueDouble;
    }
}
