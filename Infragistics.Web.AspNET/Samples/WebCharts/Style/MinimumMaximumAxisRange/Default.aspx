<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_Minimum_Maximum_Axis_Range_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table id="Table1" cellspacing="1" cellpadding="3" border="0">
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" BackColor="White" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" ChartType="SplineChart" EnableCrossHair="False" Version="5.3"
                    ...
                    <Axis BackColor="Cornsilk">
                        ...
                        <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            ...
                            <Labels ItemFormatString="&lt;ITEM_LABEL&gt;" VerticalAlign="Center" WrapText="False"
                                FontSizeBestFit="False" SeriesFormatString="" ClipText="True" Font="Verdana, 7pt"
                                Flip="False" ItemFormat="ItemLabel" FontColor="Black" Orientation="VerticalRightFacing"
                                Visible="True" OrientationAngle="0" HorizontalAlign="Near">
                    ...
                    <SplineChart DrawStyle="Solid" Thickness="3" NullHandling="Zero" MidPointAnchors="True"
                        StartStyle="DiamondAnchor" HighLightLines="False" SplineTension="0.3" EndStyle="DiamondAnchor">
                    </SplineChart>
            ...
            <td valign="top">
                <table id="Table2" cellspacing="1" cellpadding="1" border="0">
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, MinMaxRange_Label1 %>"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, MinMaxRange_Label2 %>"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, MinMaxRange_Label3 %>"></asp:Label>
                        </td>
                        <td>
                            <ig:WebNumericEditor ID="WebNumericEdit2" runat="server" Width="80px">
                            </ig:WebNumericEditor>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" colspan="2">
                            <asp:Button ID="Button1" runat="server" Text="<%$ Resources:WebCharts, ThreeDScaling_UpdateChart %>">
                            </asp:Button>
                        </td>
                    </tr>
                </table>
