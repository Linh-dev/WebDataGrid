...
public partial class Samples_WebCharts_Style_Axis_Scrollbars_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.CheckBox1.Checked = this.UltraChart1.EnableScrollBar;
        }

        this.UltraChart1.EnableScrollBar = this.CheckBox1.Checked;
    }
