<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_Axis_Scrollbars_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table id="Table1" cellspacing="1" cellpadding="3" border="0">
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" ChartImagesPath="/samplesbrowser/SamplesCommon/aspnet/WebCharts/Style/AxisScrollbars"
                    EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False" ChartType="ColumnChart"
                    Version="5.3" Width="392px" Height="288px">
            ...
            <td valign="top">
                <p>
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, AxisScrolling_Label1 %>"
