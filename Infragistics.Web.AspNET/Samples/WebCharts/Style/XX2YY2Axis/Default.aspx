<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_X_X2_Y_Y2_Axis_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False" ChartType="SplineAreaChart"
                    Version="5.3" Width="504px" Height="392px">
                    ...
                    <Axis BackColor="Cornsilk">
                        ...
                        <Y2 LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0"
                            ...
                            Extent="40" LogBase="10" RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10"
                        ...
                        <X2 LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0"
                            ...
                            Extent="50" LogBase="10" RangeMax="0" TickmarkStyle="Percentage" TickmarkPercentage="10"
                            NumericAxisType="Linear">
                            <Labels ItemFormatString="&lt;ITEM_LABEL&gt;" VerticalAlign="Far" WrapText="False"
                        ...
                        <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            RangeType="Automatic" TickmarkInterval="0" LineThickness="1" Extent="50" LogBase="10"
            ...
            <td valign="top">
                <div>
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, XX2YY2_Label1 %>"
                        AutoPostBack="True"></asp:CheckBox>
                </div>
                <div>
                    <asp:CheckBox ID="CheckBox2" runat="server" Text="<%$ Resources:WebCharts, XX2YY2_Label2 %>"
                        AutoPostBack="True"></asp:CheckBox>
                </div>
                <div>
                    <asp:CheckBox ID="CheckBox3" runat="server" Text="<%$ Resources:WebCharts, XX2YY2_Label3 %>"
                        AutoPostBack="True"></asp:CheckBox>
                </div>
                <div>
                    <asp:CheckBox ID="CheckBox4" runat="server" Text="<%$ Resources:WebCharts, XX2YY2_Label4 %>"
                        AutoPostBack="True"></asp:CheckBox>
                </div>
            </td>
        </tr>
