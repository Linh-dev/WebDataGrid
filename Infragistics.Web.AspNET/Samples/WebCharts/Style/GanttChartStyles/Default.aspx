<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_Gantt_Chart_Styles_Default" %>
        ...
        <tr>
            ...
            <td valign="top">
                <table id="Table2" cellspacing="1" cellpadding="1" border="0">
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:WebCharts, GanttChartStyles_Label1 %>"></asp:Label>
                            <br />
                            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, GanttChartStyles_Label2 %>"></asp:Label>
                        </td>
                        <td valign="top">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, GanttChartStyles_Label3 %>"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, GanttChartStyles_Label4 %>"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="<%$ Resources:WebCharts, GanttChartStyles_Label5 %>"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="<%$ Resources:WebCharts, GanttChartStyles_Label6 %>"></asp:Label>
                        </td>
                        <td>
