...
public partial class Samples_WebCharts_Style_Breakout_Pie_Slices_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.CheckBox1.Checked = this.UltraChart1.PieChart3D.BreakAllSlices;
            this.CheckBox2.Checked = this.UltraChart1.PieChart3D.BreakAlternatingSlices;
            this.CheckBox3.Checked = this.UltraChart1.PieChart3D.BreakOthersSlice;
        }

        this.UltraChart1.PieChart3D.BreakAllSlices = this.CheckBox1.Checked;
        this.UltraChart1.PieChart3D.BreakAlternatingSlices = this.CheckBox2.Checked;
        this.UltraChart1.PieChart3D.BreakOthersSlice = this.CheckBox3.Checked;
    }
    ...
    {
        this.UltraChart1.PieChart3D.BreakSlice(this.WebNumericEdit1.ValueInt, true);
    }

    private void Button2_Click(object sender, System.EventArgs e)
    {
        this.UltraChart1.PieChart3D.BreakSlice(this.WebNumericEdit1.ValueInt, false);
    }
}
