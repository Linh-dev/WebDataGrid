<%@ Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_3D_Pie_Chart_Settings_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<TABLE id="Table1" cellSpacing="1" cellPadding="3" border="0">
		<TR>
			<TD>
				<igchart:UltraChart id="UltraChart1" runat="server" BackColor="White" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ForeColor="Black" ChartType="PieChart3D" EnableCrossHair="False" Version="5.3" Transform3D-Perspective="50" Transform3D-ZRotation="0" Transform3D-Scale="75" Transform3D-XRotation="54" Transform3D-YRotation="12">
			...
			<TD vAlign="top">
				<TABLE id="Table2" cellSpacing="1" cellPadding="1" border="0">
					<TR>
						<TD>
						<asp:Label ID="StartAngle" runat="server" Text="<%$ Resources:WebCharts,Pie3DStyles_StartAngle %>"></asp:Label>
						</TD>
						<TD>
							<ig:WebNumericEditor id="WebNumericEdit1" runat="server" Width="88px"></ig:WebNumericEditor></TD>
                            <asp:RangeValidator runat="server" ID="WebNumericEdit1Validator" ControlToValidate="WebNumericEdit1"
                            Type="Double" MinimumValue="0" MaximumValue="320" ErrorMessage="<%$ Resources:WebCharts,Pie3DStyles_StartAngle_Error %>" SetFocusOnError="true"></asp:RangeValidator>
					</TR>
					<TR>
						<TD>
						<asp:Label ID="PieThickness" runat="server" Text="<%$ Resources:WebCharts,Pie3DStyles_PieThickness %>"></asp:Label>
						</TD>
						<TD>
							<ig:WebNumericEditor id="WebNumericEdit2" runat="server" Width="88px"></ig:WebNumericEditor></TD>
                            <asp:RangeValidator runat="server" ID="WebNumericEdit2Validator" ControlToValidate="WebNumericEdit2"
                            Type="Integer" MinimumValue="0" MaximumValue="40" ErrorMessage="<%$ Resources:WebCharts,Pie3DStyles_PieThickness_Error %>" SetFocusOnError="true"></asp:RangeValidator>
					</TR>
					<TR>
						<TD style="HEIGHT: 27px">
						<asp:Label ID="RadiusFactor" runat="server" Text="<%$ Resources:WebCharts,Pie3DStyles_RadiusFactor %>"></asp:Label>
						</TD>
						<TD style="HEIGHT: 27px">
							<ig:WebNumericEditor id="WebNumericEdit3" runat="server" Width="88px" MinValue="10" MaxValue="100"></ig:WebNumericEditor></TD>
					</TR>
					<TR>
						<TD align="right" colSpan="2">
							<asp:Button id="Button1" runat="server" Text="<%$ Resources:WebCharts, Pie3DStyles_UpdateChart %>"></asp:Button></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
