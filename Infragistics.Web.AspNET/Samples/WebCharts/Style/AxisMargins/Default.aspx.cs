...
public partial class Samples_WebCharts_Style_Axis_Margins_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.WebNumericEdit1.ValueDouble = this.UltraChart1.Axis.X.Margin.Near.Value;
            this.WebNumericEdit2.ValueDouble = this.UltraChart1.Axis.X.Margin.Far.Value;
            this.WebNumericEdit3.ValueDouble = this.UltraChart1.Axis.Y.Margin.Near.Value;
            this.WebNumericEdit4.ValueDouble = this.UltraChart1.Axis.Y.Margin.Far.Value;
        }
    ...
    {
        this.UltraChart1.Axis.X.Margin.Near.Value = this.WebNumericEdit1.ValueDouble;
        this.UltraChart1.Axis.X.Margin.Far.Value = this.WebNumericEdit2.ValueDouble;

        this.UltraChart1.Axis.Y.Margin.Near.Value = this.WebNumericEdit3.ValueDouble;
        this.UltraChart1.Axis.Y.Margin.Far.Value = this.WebNumericEdit4.ValueDouble;
