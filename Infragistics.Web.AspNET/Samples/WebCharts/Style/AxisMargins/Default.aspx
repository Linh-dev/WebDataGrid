<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_Axis_Margins_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False" ChartType="ScatterChart"
                    Version="5.3">
                    ...
                    <ScatterChart ColumnX="1" CharacterFont="Microsoft Sans Serif, 7.8pt" Icon="Square"
                        ConnectWithLines="False" ColumnY="2" LineAppearance-DrawStyle="Solid" LineAppearance-SplineTension="0.3"
                        LineAppearance-Thickness="3" NullHandling="Zero" GroupByColumn="0" Character="A"
                        IconSize="Small" UseGroupByColumn="False">
                    </ScatterChart>
                    ...
                    <Axis BackColor="Cornsilk">
                        <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            ...
                            <Margin>
                                ...
                                <Near MarginType="Percentage" Value="15"></Near>
                            </Margin>
                        </Y>
                        ...
                        <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            RangeType="Automatic" TickmarkInterval="5" LineThickness="1" Extent="30" LogBase="10"
                            RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10" NumericAxisType="Linear">
                            <StripLines Interval="2" Visible="False">
                                <PE FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill"
                                    Fill="Transparent" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit"
            ...
            <td valign="top">
                <div>
                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, AxisMargins_Label1 %>"></asp:Label>
                </div>
                <div style="margin-top: 10px;">
                    <div style="float: left; width: 100px; padding-top: 3px;">
                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, AxisMargins_Label2 %>"></asp:Label>
                    </div>
                    <div style="float: left;">
                        <ig:WebNumericEditor ID="WebNumericEdit1" runat="server" Width="88px">
                        </ig:WebNumericEditor>
                    </div>
                ...
                <div>
                    <div style="float: left; width: 100px; padding-top: 3px;">
                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:WebCharts, AxisMargins_Label3 %>"></asp:Label>
                    </div>
                    <div style="float: left;">
                        <ig:WebNumericEditor ID="WebNumericEdit2" runat="server" Width="88px">
                        </ig:WebNumericEditor>
                    </div>
                    <div style="clear: both;">
                    </div>
                ...
                <div>
                    <div style="float: left; width: 100px; padding-top: 3px;">
                        <asp:Label ID="Label6" runat="server" Text="<%$ Resources:WebCharts, AxisMargins_Label4 %>"></asp:Label>
                    </div>
                    <div style="float: left;">
                        <ig:WebNumericEditor ID="WebNumericEdit3" runat="server" Width="88px">
                        </ig:WebNumericEditor>
                    </div>
                    <div style="clear: both;">
                    </div>
                ...
                <div>
                    <div style="float: left; width: 100px; padding-top: 3px;">
                        <asp:Label ID="Label7" runat="server" Text="<%$ Resources:WebCharts, AxisMargins_Label5 %>"></asp:Label>
                    </div>
                    <div style="float: left;">
                        <ig:WebNumericEditor ID="WebNumericEdit4" runat="server" Width="88px">
                        </ig:WebNumericEditor>
                    </div>
                    <div style="clear: both;">
                    </div>
