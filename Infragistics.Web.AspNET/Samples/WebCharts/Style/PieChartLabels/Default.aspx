<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_Pie_Chart_Labels_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
	...
	<TABLE id="Table1" cellSpacing="1" cellPadding="3" border="0">
		<TR>
			<TD>
				<igchart:UltraChart id="UltraChart1" runat="server" BackColor="White" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ForeColor="Black" ChartType="PieChart" EnableCrossHair="False" Version="5.3">
					...
					<PieChart ConcentricSpacing="0.25" OthersCategoryPercent="3" BreakAlternatingSlices="False" BreakDistancePercentage="10" BreakOthersSlice="False" ColumnIndex="-1" Concentric="False" PieThickness="20" BreakAllSlices="False" StartAngle="0" OthersCategoryText="Others" RadiusFactor="80" ShowConcentricLegend="True">
			...
			<TD vAlign="top">
				<TABLE id="Table2" cellSpacing="1" cellPadding="1" border="0">
					<TR>
						<TD><asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, PieLabels_Label1 %>"></asp:Label></TD>
						<TD>
							<asp:CheckBox id="CheckBox1" runat="server"></asp:CheckBox></TD>
					</TR>
					<TR>
						<TD><asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, PieLabels_Label2 %>"></asp:Label></TD>
						<TD>
							<asp:DropDownList id="DropDownList1" runat="server"></asp:DropDownList></TD>
					</TR>
					<TR>
						<TD><asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, PieLabels_Label3 %>"></asp:Label></TD>
						<TD>
							<asp:DropDownList id="DropDownList2" runat="server"></asp:DropDownList></TD>
					</TR>
					<TR>
						<TD><asp:Label ID="Label5" runat="server" Text="<%$ Resources:WebCharts, PieLabels_Label4 %>"></asp:Label></TD>
						<TD>
							<ig:WebNumericEditor id="WebNumericEdit1" runat="server" Width="72px" MaxValue="10" MinValue="1"></ig:WebNumericEditor></TD>
					</TR>
					<TR>
						<TD align="right" colSpan="2">
							<asp:Button id="Button1" runat="server" Text="<%$ Resources:WebCharts, PieLabels_Label5 %>"></asp:Button></TD>
					</TR>
				</TABLE>
			</TD>
		</TR>
