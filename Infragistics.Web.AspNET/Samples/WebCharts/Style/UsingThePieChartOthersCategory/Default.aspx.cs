...
public partial class Samples_WebCharts_Style_Using_The_Pie_Chart_Others_Category_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.WebNumericEdit1.ValueDouble = this.UltraChart1.PieChart.OthersCategoryPercent;
            this.TextBox1.Text = this.UltraChart1.PieChart.OthersCategoryText;
        }
    }
    ...
    {
        this.UltraChart1.PieChart.OthersCategoryPercent = this.WebNumericEdit1.ValueDouble;
        this.UltraChart1.PieChart.OthersCategoryText = this.TextBox1.Text;
    }
