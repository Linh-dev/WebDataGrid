<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_Using_The_Pie_Chart_Others_Category_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <TABLE id="Table1" cellSpacing="1" cellPadding="3" border="0">
	    <TR>
		    <TD>
			    <igchart:UltraChart id="UltraChart1" runat="server" BackColor="White" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ForeColor="Black" EnableCrossHair="False" ChartType="PieChart" Version="5.3">
				    ...
				    <PieChart ConcentricSpacing="0.25" OthersCategoryPercent="10" BreakAlternatingSlices="False" BreakDistancePercentage="10" BreakOthersSlice="False" ColumnIndex="-1" Concentric="False" PieThickness="20" BreakAllSlices="False" StartAngle="0" OthersCategoryText="Others" RadiusFactor="80" ShowConcentricLegend="True">
					    <Labels Font="Microsoft Sans Serif, 7.8pt" Visible="True" FormatString="&lt;ITEM_LABEL&gt;&lt;PERCENT_VALUE:#0.00&gt;%" LeaderLineThickness="1" FillColor="Transparent" LeaderLinesVisible="True" BorderDrawStyle="Solid" Format="Label_and_Percent" BorderThickness="0" LeaderEndStyle="ArrowAnchor" FontColor="Black" BorderColor="Black" LeaderDrawStyle="Dot"></Labels>
				    </PieChart>
		    ...
		    <TD vAlign="top">
			    <TABLE id="Table2" cellSpacing="1" cellPadding="1" border="0">
				    <TR>
					    <TD><asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, OthersCategoryDisplay_Label1 %>"></asp:Label></TD>
					    <TD>
						    <ig:WebNumericEditor id="WebNumericEdit1" runat="server" Width="96px"></ig:WebNumericEditor></TD>
				    </TR>
				    <TR>
					    <TD><asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, OthersCategoryDisplay_Label2 %>"></asp:Label></TD>
					    <TD>
						    <asp:TextBox id="TextBox1" runat="server" Width="96px"></asp:TextBox></TD>
				    </TR>
				    <TR>
					    <TD align="right" colSpan="2">
						    <asp:Button id="Button1" runat="server" Text="<%$ Resources:WebCharts, OthersCategoryDisplay_Label3 %>"></asp:Button></TD>
				    </TR>
			    </TABLE>
		    </TD>
	    </TR>
