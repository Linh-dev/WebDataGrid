<%@ Page language="c#" MasterPageFile="~/SamplePage.master" CodeFile="Default.aspx.cs" AutoEventWireup="false" Inherits="Samples_WebCharts_Style_Concentric_Doughnut_Charts_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<TABLE id="Table2" cellSpacing="1" cellPadding="3" border="0">
		<TR>
			<TD>
				<igchart:UltraChart id="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ForeColor="Black" ChartType="DoughnutChart" BackColor="White" EnableCrossHair="False" Version="5.3" DESIGNTIMEDRAGDROP="43">
					...
					<DoughnutChart OthersCategoryText="Others" InnerRadius="50" ConcentricSpacing="0.25" BreakAlternatingSlices="False" OthersCategoryPercent="3" BreakOthersSlice="False" ColumnIndex="-1" Concentric="True" PieThickness="20" BreakAllSlices="False" StartAngle="0" BreakDistancePercentage="10" RadiusFactor="80" ShowConcentricLegend="True">
			...
			<TD vAlign="top">
				<TABLE id="Table1" cellSpacing="1" cellPadding="1" border="0">
					<TR>
						<TD><asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, ConcentricDoughnut_Label1 %>"></asp:Label></TD>
						<TD>
							<ig:WebNumericEditor id="WebNumericEdit1" runat="server" Width="80px" MinValue="0.0" MaxValue="1.0"></ig:WebNumericEditor></TD>
					</TR>
					<TR>
						<TD><asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, ConcentricDoughnut_Label2 %>"></asp:Label></TD>
						<TD>
							<ig:WebNumericEditor id="WebNumericEdit2" runat="server" Width="80px" MinValue="0" MaxValue="99"></ig:WebNumericEditor></TD>
					</TR>
					<TR>
						<TD><asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, ConcentricDoughnut_Label3 %>"></asp:Label></TD>
						<TD>
