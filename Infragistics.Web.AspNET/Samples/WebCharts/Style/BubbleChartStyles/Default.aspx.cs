...
public partial class Samples_WebCharts_Style_Bubble_Chart_Styles_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            string[] bubbleShape = System.Enum.GetNames(typeof(BubbleShape));
            foreach (string s in bubbleShape)
            {
                this.DropDownList1.Items.Add(s);
            }

            string[] chartSortType = System.Enum.GetNames(typeof(ChartSortType));
            foreach (string s in chartSortType)
            {
                this.DropDownList2.Items.Add(s);
            }

            this.DropDownList1.Items.FindByValue(System.Enum.GetName(typeof(BubbleShape), this.UltraChart1.BubbleChart.BubbleShape)).Selected = true;
            this.DropDownList2.Items.FindByValue(System.Enum.GetName(typeof(ChartSortType), this.UltraChart1.BubbleChart.SortByRadius)).Selected = true;
        }

        this.UltraChart1.BubbleChart.BubbleShape = (BubbleShape)System.Enum.Parse(typeof(BubbleShape), this.DropDownList1.SelectedItem.Value);
        this.UltraChart1.BubbleChart.SortByRadius = (ChartSortType)System.Enum.Parse(typeof(ChartSortType), this.DropDownList2.SelectedItem.Value);
    }
