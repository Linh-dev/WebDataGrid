...
public partial class Samples_WebCharts_Style_Controlling_Candle_Chart_Visibility_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.CheckBox1.Checked = this.UltraChart1.CandleChart.HighLowVisible;
            this.CheckBox2.Checked = this.UltraChart1.CandleChart.OpenCloseVisible;
            this.CheckBox3.Checked = this.UltraChart1.CandleChart.VolumeVisible;
        }

        this.UltraChart1.CandleChart.HighLowVisible = this.CheckBox1.Checked;
        this.UltraChart1.CandleChart.OpenCloseVisible = this.CheckBox2.Checked;
        this.UltraChart1.CandleChart.VolumeVisible = this.CheckBox3.Checked;
    }
