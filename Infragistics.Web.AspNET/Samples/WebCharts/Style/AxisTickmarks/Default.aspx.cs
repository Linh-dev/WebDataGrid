...
public partial class Samples_WebCharts_Style_Axis_Tickmarks_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            string[] tickmarkStyle = System.Enum.GetNames(typeof(AxisTickStyle));
            foreach (string s in tickmarkStyle)
            {
                this.DropDownList1.Items.Add(s);
            }

            this.DropDownList1.SelectedIndex = this.DropDownList1.Items.IndexOf(this.DropDownList1.Items.FindByText(this.UltraChart1.Axis.X.TickmarkStyle.ToString()));
            this.WebNumericEdit1.Value = this.UltraChart1.Axis.X.TickmarkInterval;
            this.WebNumericEdit2.Value = this.UltraChart1.Axis.X.TickmarkPercentage;
        }

        this.UltraChart1.Axis.X.TickmarkStyle = (AxisTickStyle)System.Enum.Parse(typeof(AxisTickStyle), this.DropDownList1.SelectedItem.Value);
        this.UltraChart1.Axis.X.TickmarkInterval = (double)this.WebNumericEdit1.Value;
        this.UltraChart1.Axis.X.TickmarkPercentage = (double)this.WebNumericEdit2.Value;
        this.UltraChart1.Axis.Y.TickmarkStyle = (AxisTickStyle)System.Enum.Parse(typeof(AxisTickStyle), this.DropDownList1.SelectedItem.Value);
        this.UltraChart1.Axis.Y.TickmarkInterval = (double)this.WebNumericEdit1.Value;
        this.UltraChart1.Axis.Y.TickmarkPercentage = (double)this.WebNumericEdit2.Value;

        switch (this.DropDownList1.SelectedItem.Value)
        {
            case "Smart":
                this.WebNumericEdit1.Enabled = false;
                this.WebNumericEdit2.Enabled = false;
            ...
            case "Percentage":
                this.WebNumericEdit1.Enabled = false;
                this.WebNumericEdit2.Enabled = true;
                this.Button1.Enabled = true;
                break;
        }
