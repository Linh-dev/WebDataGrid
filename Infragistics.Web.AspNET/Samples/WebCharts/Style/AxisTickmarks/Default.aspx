<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Style_Axis_Tickmarks_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <ul style="font-size: 0.85em; margin-top : -15px; color: #656565; list-style-position: inside;">
	    <li>
		    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Description2 %>"></asp:Label><br />
		    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Description3 %>"></asp:Label><br />
	    </li>
	    <li>
		    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Description4 %>"></asp:Label><br />
		    <asp:Label ID="Label5" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Description5 %>"></asp:Label><br />
	    </li>
	    <li>
		    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Description6 %>"></asp:Label><br />
		    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Description7 %>"></asp:Label>
        </li>
    </ul>
    <p style="font-size: 0.85em;">
        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Description8 %>"></asp:Label>
    </p>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ...
                    Version="5.3" Height="299px" Transform3D-YRotation="12" Transform3D-XRotation="144"
                    Transform3D-Scale="65" Transform3D-ZRotation="0">
                    ...
                    <Axis BackColor="Cornsilk">
                        ...
                        <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            RangeType="Automatic" TickmarkInterval="25" LineThickness="1" Extent="80" LogBase="10"
            ...
            <td valign="top">
                <div style="margin-bottom: 5px;">
                    <div style="float: left; width: 110px; padding-top: 3px;">
                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Label1 %>"></asp:Label>
                    </div>
                ...
                <div style="margin-top: 5px;">
                    <div style="float: left; width: 110px; padding-top: 3px;">
                        <asp:Label ID="Label10" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Label2 %>"></asp:Label>
                    </div>
                    <div style="float: left;">
                        <ig:WebNumericEditor ID="WebNumericEdit1" runat="server" Width="80px">
                        </ig:WebNumericEditor>
                    </div>
                    <div style="clear: both;"></div>
                </div>
                <div style="margin-top: 5px;">
                    <div style="float: left; width: 110px; padding-top: 3px;">
                        <asp:Label ID="Label11" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Label3 %>"></asp:Label>
                    </div>
                    <div style="float: left;">
                        <ig:WebNumericEditor ID="WebNumericEdit2" runat="server" Width="80px" MinValue="0" MaxValue="100">
                        </ig:WebNumericEditor>
                    </div>
                    <div style="clear: both;"></div>
                </div>
                <div style="padding-left: 100px; margin-top: 5px;">
                    <asp:Button ID="Button1" runat="server" Text="<%$ Resources:WebCharts, AxisTickmarks_Label4 %>">
                    </asp:Button>
                </div>
