<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Bar_And_Column_Charts_Column_Chart_Styles_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
        ForeColor="Black" ChartType="ColumnChart" BackColor="White" EnableCrossHair="False"
        Version="5.3" Transform3D-YRotation="12" Transform3D-XRotation="144" Transform3D-Scale="50"
        Transform3D-ZRotation="0">
    ...
    <td valign="top">
        <table id="Table2" cellspacing="1" cellpadding="1" border="0">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, ColumnChartStyles_Label1 %>"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right" colspan="2">
                    <asp:Button ID="Button1" runat="server" Text="<%$ Resources:WebCharts, ColumnChartStyles_Label2 %>">
                    </asp:Button>
                </td>
            </tr>
        </table>
