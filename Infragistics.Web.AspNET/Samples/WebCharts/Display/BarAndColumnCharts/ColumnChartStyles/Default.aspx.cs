...
public partial class Samples_WebCharts_Display_Bar_And_Column_Charts_Column_Chart_Styles_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.WebNumericEdit1.ValueInt = this.UltraChart1.ColumnChart3D.ColumnSpacing;
        }
    }
    ...
    {
        this.UltraChart1.ColumnChart.ColumnSpacing = this.WebNumericEdit1.ValueInt;
    }
}