<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Bar_And_Column_Charts_Column_Line_Hybrid_Charts_Default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="ColumnLineChart">
        ...
        <ColumnLineChart>
            <Column SeriesSpacing="0" ColumnSpacing="0" NullHandling="Zero">
            </Column>
            <Line DrawStyle="Solid" Thickness="3" NullHandling="Zero" MidPointAnchors="True"
                StartStyle="DiamondAnchor" HighLightLines="False" EndStyle="DiamondAnchor">
            </Line>
            <ColumnData DataMember="" SwapRowsAndColumns="False" UseMinMax="False" UseRowLabelsColumn="False"
                MinValue="-1.7976931348623157E+308" RowLabelsColumn="-1" ZeroAligned="False"
                MaxValue="1.7976931348623157E+308">
                <EmptyStyle Text="Empty" EnableLineStyle="False" ShowInLegend="False" EnablePE="False"
                    EnablePoint="False">
            ...
            <LineData DataMember="" SwapRowsAndColumns="False" UseMinMax="False" UseRowLabelsColumn="False"
                MinValue="-1.7976931348623157E+308" RowLabelsColumn="-1" ZeroAligned="False"
                MaxValue="1.7976931348623157E+308">
                <EmptyStyle Text="Empty" EnableLineStyle="False" ShowInLegend="False" EnablePE="False"
                    EnablePoint="False">
        ...
        <Axis BackColor="Cornsilk">
            <Y LineEndCapStyle="Flat" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
            ...
            <Y2 LineEndCapStyle="Flat" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
            ...
            <X2 LineEndCapStyle="Flat" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
            ...
            <X LineEndCapStyle="Flat" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
