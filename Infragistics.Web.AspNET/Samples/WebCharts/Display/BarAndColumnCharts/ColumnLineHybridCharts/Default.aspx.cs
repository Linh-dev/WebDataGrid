...
using WebSamplesCS;
public partial class Samples_WebCharts_Display_Bar_And_Column_Charts_Column_Line_Hybrid_Charts_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
