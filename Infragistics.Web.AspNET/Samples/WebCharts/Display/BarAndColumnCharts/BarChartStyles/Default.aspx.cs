...
public partial class Samples_WebCharts_Display_Bar_And_Column_Charts_Bar_Chart_Styles_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.WebNumericEdit1.ValueInt = this.UltraChart1.BarChart.BarSpacing;
            this.WebNumericEdit2.ValueInt = this.UltraChart1.BarChart.SeriesSpacing;
        }
    }
    ...
    {
        this.UltraChart1.BarChart.BarSpacing = this.WebNumericEdit1.ValueInt;
        this.UltraChart1.BarChart.SeriesSpacing = this.WebNumericEdit2.ValueInt;
    }
}