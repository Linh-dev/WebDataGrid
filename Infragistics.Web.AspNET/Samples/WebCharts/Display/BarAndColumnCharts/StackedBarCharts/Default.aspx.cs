...
using WebSamplesCS;
public partial class Samples_WebCharts_Display_Bar_And_Column_Charts_Stacked_Bar_Charts_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
