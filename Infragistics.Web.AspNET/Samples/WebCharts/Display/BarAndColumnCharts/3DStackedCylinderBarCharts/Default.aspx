<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Bar_And_Column_Charts_3D_Stacked_Cylinder_Bar_Charts_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table id="Table1" cellspacing="4" cellpadding="1" border="0">
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="CylinderStackBarChart3D"
                    Width="300px" Height="300px" Transform3D-YRotation="41" Transform3D-XRotation="144"
                    Transform3D-Scale="65" Transform3D-ZRotation="0" Transform3D-Perspective="50">
            ...
            <td>
                <igchart:UltraChart ID="UltraChart2" runat="server" ChartType="CylinderStackColumnChart3D"
                    Transform3D-Perspective="50" Transform3D-ZRotation="0" Transform3D-Scale="55"
                    Transform3D-XRotation="144" Transform3D-YRotation="12" Width="300px">
                    <Border CornerRadius="0" DrawStyle="Solid" Raised="False" Color="Black" Thickness="1">
                    </Border>
                    <TitleRight Font="Microsoft Sans Serif, 7.8pt" Visible="False" Text="" FontSizeBestFit="False"
                        Orientation="VerticalRightFacing" WrapText="False" Extent="26" FontColor="Black"
