<%@ Page CodeFile="Default.aspx.cs" MasterPageFile="~/SamplePage.master" Language="c#" AutoEventWireup="false" Inherits="Samples_WebCharts_Display_Doughnut_Charts_Default" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
	<igchart:UltraChart id="UltraChart1" runat="server" ChartType="DoughnutChart">
		...
		<DoughnutChart OthersCategoryText="Others" InnerRadius="50" ConcentricSpacing="0.25" BreakAlternatingSlices="False" OthersCategoryPercent="3" BreakOthersSlice="False" ColumnIndex="-1" Concentric="False" PieThickness="20" BreakAllSlices="False" StartAngle="0" BreakDistancePercentage="10" RadiusFactor="90" ShowConcentricLegend="True">
