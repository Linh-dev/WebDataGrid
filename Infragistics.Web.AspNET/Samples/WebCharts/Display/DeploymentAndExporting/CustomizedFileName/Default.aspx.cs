...
public partial class Samples_WebCharts_Display_Deployment_And_Exporting_Customized_FileName_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        this.TextBox1.Text = System.IO.Path.GetFileName(this.UltraChart1.DeploymentScenario.ImageURL);
    }
    ...
    {
        string filename = "/SamplesBrowser/Temp/ChartImages/";
        ...
        {
            filename += System.DateTime.Now.ToString("dd-MM-yyyyThhmmss") + ".jpg";
        }
        ...
        this.UltraChart1.DeploymentScenario.ImageURL = filename;
    }
}