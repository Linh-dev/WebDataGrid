<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Deployment_And_Exporting_Customized_FileName_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script type="text/javascript">
        function refreshTextBox1Disable()
        {
            ...
            <td valign="top">
                <p>
                    <table id="Table2" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td colspan="2">
                                <asp:RadioButton ID="RadioButton1" runat="server" GroupName="FileName"
                                    Checked="True" Text="<%$ Resources:WebCharts, CustomizedFileName_Label1 %>">
                                </asp:RadioButton>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:RadioButton ID="RadioButton2" runat="server" GroupName="FileName"
                                    Text="<%$ Resources:WebCharts, CustomizedFileName_Label2 %>">
                                </asp:RadioButton>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="height: 21px">
                                <asp:RadioButton ID="RadioButton3" runat="server" GroupName="FileName"
                                    Text="<%$ Resources:WebCharts, CustomizedFileName_Label3 %>">
                                </asp:RadioButton>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" colspan="2">
                                <asp:Button ID="Button1" runat="server" Text="<%$ Resources:WebCharts, CustomizedFileName_Update %>"
