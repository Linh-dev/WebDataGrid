...
public partial class Samples_WebCharts_Display_Deployment_And_Exporting_Render_Formats_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            string[] chartTypes = System.Enum.GetNames(typeof(RenderingType));
        ...
        Page.RegisterStartupScript("focus", "<script>document.getElementById('" + this.DropDownList1.ClientID + "').focus();</script>");
    }
    ...
    {
        RenderingType t = (RenderingType)System.Enum.Parse(typeof(RenderingType), this.DropDownList1.SelectedItem.Value);
        this.UltraChart1.DeploymentScenario.RenderingType = t;

        if (this.DropDownList1.SelectedItem.Value == "Image")
        {
    ...
    {
        System.Reflection.PropertyInfo pi = typeof(System.Drawing.Imaging.ImageFormat).GetProperty(this.DropDownList2.SelectedItem.Value);
        this.UltraChart1.DeploymentScenario.ImageType = (ImageFormat)pi.GetValue(null, null);
        this.UltraChart1.DeploymentScenario.ImageURL = System.IO.Path.ChangeExtension(this.UltraChart1.DeploymentScenario.ImageURL, this.DropDownList2.SelectedItem.Value);
    }
}