<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Chart_Customization_Custom_Gauge_Layer_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table id="Table3" cellspacing="1" cellpadding="3" border="0">
        <tr>
            <td>
                <table id="Table1" cellspacing="1" cellpadding="10" width="300" border="0">
                    <tr>
                        <td colspan="2">
                            <p align="center">
                                <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, GaugeCustomChartLayers_Label1 %>"></asp:Label></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 369px; height: 317px">
                            <igchart:UltraChart ID="UltraChart1" runat="server" Width="270px" Height="315px">
                                <Border CornerRadius="5" DrawStyle="Solid" Raised="True" Color="Black" Thickness="1">
                                </Border>
                                ...
                                <TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="UltraChart Gauge"
                                    FontSizeBestFit="False" Orientation="Horizontal" WrapText="False" Extent="33"
                                    FontColor="Black" HorizontalAlign="Center" VerticalAlign="Center" Location="Top">
                                    <Margins Bottom="5" Left="5" Top="5" Right="5"></Margins>
                                </TitleTop>
                                <DeploymentScenario Scenario="FileSystem" ImageURL="/SamplesBrowser/Temp/ChartImages/Chart1_#SEQNUM(100).jpg"
                        ...
                        <td>
                            <igchart:UltraChart ID="UltraChart2" runat="server" Width="270px" Height="315px">
                                <Border CornerRadius="5" DrawStyle="Solid" Raised="True" Color="Black" Thickness="1">
                                </Border>
                                <TitleRight Font="Microsoft Sans Serif, 7.8pt" Visible="False" Text="UltraChart for .NET is #1 !"
                                    FontSizeBestFit="False" Orientation="VerticalRightFacing" WrapText="False" Extent="26"
                                ...
                                <TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="YTD PEBIT" FontSizeBestFit="False"
                                    Orientation="Horizontal" WrapText="False" Extent="33" FontColor="Black" HorizontalAlign="Center"
                                    VerticalAlign="Center" Location="Top">
                                    <Margins Bottom="5" Left="5" Top="5" Right="5"></Margins>
                                </TitleTop>
                                <DeploymentScenario Scenario="FileSystem" ImageURL="/SamplesBrowser/Temp/ChartImages/Chart2_#SEQNUM(100).jpg"
                                    ImageType="Jpeg" FilePath="/SamplesBrowser/Temp/ChartImages">
                                </DeploymentScenario>
                                <Tooltips BorderThickness="1" Overflow="None" FormatString="&lt;DATA_VALUE:00.##&gt;"
                                    EnableFadingEffect="False" Format="DataValue" FontColor="Black" BorderColor="Black"
            ...
            <td valign="top">
                <table>
                    <tr>
                        <td colspan="2">
                          <asp:Label ID="Label5" runat="server" Text="<%$ Resources:WebCharts, GaugeCustomChartLayers_Label3 %>"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                             <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" Width="100px">
                                <asp:ListItem Value="None" Text="<%$ Resources:AppStrings, None %>" Selected="True"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
    ...
    <table id="Table2" style="position: relative; left: 14px; width: 562px; height: 59px" cellspacing="1" cellpadding="1" border="1">
        <tr>
            <td></td>
            <td>
                <strong>
                    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:WebCharts, GaugeCustomChartLayers_Label4 %>"></asp:Label>
                </strong>
            </td>
            <td>
                <strong>
                    <asp:Label ID="Label8" runat="server" Text="<%$ Resources:WebCharts, GaugeCustomChartLayers_Label5 %>"></asp:Label>
                </strong>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:WebCharts, GaugeCustomChartLayers_Label6 %>"></asp:Label>
            </td>
            <td>
                10%
            </td>
