<%@ Page CodeFile="Default.aspx.cs" MasterPageFile="~/SamplePage.master" Language="c#" AutoEventWireup="false" Inherits="Samples_WebCharts_Display_Candle_Charts_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<igchart:UltraChart id="UltraChart1" runat="server" ChartType="CandleChart">
		...
		<ColorModel ColorBegin="DarkGoldenrod" ColorEnd="Navy" AlphaLevel="255" ModelStyle="PureRandom" Grayscale="False" Scaling="None">
		...
		<Axis BackColor="Cornsilk">
			...
			<X2 LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="False" RangeMin="0" LineColor="Black" RangeType="Automatic" TickmarkInterval="0" LineThickness="2" Extent="80" LogBase="10" RangeMax="0" TickmarkStyle="Percentage" TickmarkPercentage="10" NumericAxisType="Linear">
				...
				<ScrollScale Scale="1" Scroll="0" Height="10" Width="15" Visible="False"></ScrollScale>
				<Labels ItemFormatString="&lt;ITEM_LABEL:MM-dd-yy&gt;" VerticalAlign="Center" WrapText="False" FontSizeBestFit="False" SeriesFormatString="" ClipText="True" Font="Microsoft Sans Serif, 7.8pt" Flip="False" ItemFormat="Custom" FontColor="Black" Orientation="VerticalLeftFacing" Visible="True" OrientationAngle="0" HorizontalAlign="Far">
		...
		<CandleChart WickColor="60, 60, 60" VolumeColor="Gainsboro" OpenCloseVisible="True" NegativeRangeColor="7, 108, 176" SkipN="1" VolumeVisible="False" HighLowVisible="True" WickThickness="1" PositiveRangeColor="108, 162, 36"></CandleChart>
