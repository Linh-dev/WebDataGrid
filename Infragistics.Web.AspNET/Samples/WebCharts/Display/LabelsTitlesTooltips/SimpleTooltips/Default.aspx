<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Labels_Titles_Tooltips_Simple_Tooltips_Default" %>
                    ...
                    <td>
                        <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                            ...
                            <Tooltips BorderThickness="1" Overflow="None" FormatString="&lt;DATA_VALUE:00.##&gt;"
                                EnableFadingEffect="False" Format="DataValue" Font-Names="Verdana,Arial" FontColor="Black"
                                BorderColor="Black" Display="MouseMove" BackColor="AntiqueWhite" Padding="0">
                            </Tooltips>
                        </igchart:UltraChart>
                    </td>
                    <td valign="top">
                        <table id="Table1" cellspacing="1" cellpadding="1" border="0">
                            <tr>
                                <td>
                                    <asp:Label ID="TableData1" runat="server" Text="<%$ Resources:WebCharts,SimpleTooltips_TableData_1 %>"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="TableData2" runat="server" Text="<%$ Resources:WebCharts,SimpleTooltips_TableData_2 %>"></asp:Label>
                                </td>
                                <td>
