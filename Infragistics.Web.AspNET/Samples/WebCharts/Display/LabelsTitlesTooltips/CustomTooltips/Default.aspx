<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Labels_Titles_Tooltips_Custom_Tooltips_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table id="Table1" cellspacing="1" cellpadding="3" border="0">
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" Version="5.3" ChartType="BarChart"
                    ...
                    <Axis BackColor="Cornsilk">
                        <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            ...
                            <Labels ItemFormatString="&lt;ITEM_LABEL&gt;" VerticalAlign="Center" WrapText="False"
                                ...
                                <SeriesLabels Font="Microsoft Sans Serif, 7.8pt" Visible="False" HorizontalAlign="Center"
            ...
            <td valign="top">
                <asp:CheckBox ID="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, CustomTooltips_CheckBox_1 %>"
