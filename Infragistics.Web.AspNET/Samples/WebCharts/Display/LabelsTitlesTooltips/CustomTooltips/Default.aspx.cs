...
public partial class Samples_WebCharts_Display_Labels_Titles_Tooltips_Custom_Tooltips_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (this.CheckBox1.Checked)
        {
            ...
            labelHash.Add("HIGHLOW", new ChartSamples.LabelsTitlesTooltips.CustomTooltips.MyCustomTooltip());
        ...
        {
            this.UltraChart1.Tooltips.Format = TooltipStyle.DataValue;
        }
    }
