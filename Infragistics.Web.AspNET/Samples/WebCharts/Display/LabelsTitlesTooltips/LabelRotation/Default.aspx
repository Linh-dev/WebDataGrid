<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Labels_Titles_Tooltips_Label_Rotation_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False" ChartType="HeatMapChart"
                    Version="5.3">
                    ...
                    <Axis BackColor="Cornsilk">
                        <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            ...
                            <Labels ItemFormatString="&lt;ITEM_LABEL&gt;" VerticalAlign="Center" WrapText="False"
                                FontSizeBestFit="False" ClipText="True" Font="Verdana, 7pt" Flip="False" ItemFormat="ItemLabel"
                                FontColor="Black" Orientation="Horizontal" Visible="True" OrientationAngle="0"
                                HorizontalAlign="Far">
                        ...
                        <Y2 LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="False" RangeMin="0"
                            ...
                            <ScrollScale Scale="1" Scroll="0" Height="10" Width="15" Visible="False"></ScrollScale>
                            <Labels ItemFormatString="&lt;ITEM_LABEL&gt;" VerticalAlign="Center" WrapText="False"
                                FontSizeBestFit="False" ClipText="True" Font="Microsoft Sans Serif, 7.8pt" Flip="False"
                                ItemFormat="ItemLabel" FontColor="Black" Orientation="Horizontal" Visible="True"
                        ...
                        <X2 LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="False" RangeMin="0"
                            ...
                            <Labels ItemFormatString="&lt;ITEM_LABEL&gt;" VerticalAlign="Center" WrapText="False"
                                FontSizeBestFit="False" ClipText="True" Font="Microsoft Sans Serif, 7.8pt" Flip="False"
                                ItemFormat="ItemLabel" FontColor="Black" Orientation="VerticalLeftFacing" Visible="True"
                                OrientationAngle="0" HorizontalAlign="Near">
                                <SeriesLabels Font="Microsoft Sans Serif, 7.8pt" Visible="True" HorizontalAlign="Near"
                                    FontSizeBestFit="False" ClipText="False" FormatString="&lt;SERIES_LABEL&gt;" Orientation="Horizontal"
                                    WrapText="False" Flip="False" FontColor="Black" VerticalAlign="Center" OrientationAngle="0">
                                </SeriesLabels>
                            </Labels>
                            <MajorGridLines AlphaLevel="255" DrawStyle="Dot" Color="Gainsboro" Visible="True"
                        ...
                        <Z2 LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="False" RangeMin="0"
                            ...
                            <Labels ItemFormatString="" VerticalAlign="Center" WrapText="False" FontSizeBestFit="False"
                                ClipText="True" Font="Microsoft Sans Serif, 7.8pt" Flip="False" ItemFormat="None"
                                FontColor="Black" Orientation="Horizontal" Visible="True" OrientationAngle="0"
                        ...
                        <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            ...
                            <TimeAxisStyle TimeAxisStyle="Continuous"></TimeAxisStyle>
                            <Margin>
                                <Far MarginType="Percentage" Value="10"></Far>
                                <Near MarginType="Percentage" Value="0"></Near>
                            </Margin>
                        </X>
                    </Axis>
                    ...
                    <HeatMapChart RenderQuality="MediumQuality" NullHandling="Zero">
                    </HeatMapChart>
            ...
            <td valign="top">
                <p>
                    <table id="Table1" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td>
                                <asp:Label ID="TextOrientation" runat="server" Text="<%$ Resources:WebCharts, SeriesLabelRotation_TableData_1 %>"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="OrientationAngle" runat="server" Text="<%$ Resources:WebCharts, SeriesLabelRotation_TableData_2 %>"></asp:Label>
                            </td>
                            <td>
                                <ig:WebNumericEditor ID="WebNumericEdit1" runat="server" Width="104px">
                                </ig:WebNumericEditor>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="FlipLabels" runat="server" Text="<%$ Resources:WebCharts, SeriesLabelRotation_TableData_3 %>"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:Button ID="Button2" runat="server" Text="<%$ Resources:WebCharts, SeriesLabelRotation_Button_1 %>">
                                </asp:Button>
                            </td>
                        </tr>
                    </table>
