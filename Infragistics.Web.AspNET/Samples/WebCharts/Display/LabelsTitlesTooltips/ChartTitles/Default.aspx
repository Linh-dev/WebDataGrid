<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Labels_Titles_Tooltips_Chart_Titles_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False" ChartType="BubbleChart"
                    Version="5.3">
                    <Border CornerRadius="5" DrawStyle="Solid" Raised="False" Color="Black" Thickness="1">
                    </Border>
                    <BubbleChart SortByRadius="None" ColumnX="0" ColumnY="1" ColumnZ="2" NullHandling="Zero"
                        BubbleShape="Circle" ColorCueColumn="-1">
                    </BubbleChart>
                    <TitleRight Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="Right Title"
                    ...
                    <TitleLeft Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="Left Title" FontSizeBestFit="False"
                    ...
                    <Axis BackColor="Cornsilk">
                        <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            RangeType="Automatic" TickmarkInterval="10" LineThickness="1" Extent="30" LogBase="10"
                        ...
                        <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            RangeType="Automatic" TickmarkInterval="10" LineThickness="1" Extent="40" LogBase="10"
                            RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10" NumericAxisType="Linear">
                            <StripLines Interval="2" Visible="False">
                                <PE FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill"
                                    Fill="Transparent" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit"
                    ...
                    <TitleBottom Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="Bottom Title"
                    ...
                    <TitleTop Font="Microsoft Sans Serif, 7.8pt" Visible="True" Text="Top Title" FontSizeBestFit="False"
            ...
            <td valign="top">
                <p>
                    <table id="Table1" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, Titles_Label1 %>"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, Titles_Label2 %>"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:WebCharts, Titles_Label3 %>"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label6" runat="server" Text="<%$ Resources:WebCharts, Titles_Label4 %>"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label7" runat="server" Text="<%$ Resources:WebCharts, Titles_Label5 %>"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label8" runat="server" Text="<%$ Resources:WebCharts, Titles_Label6 %>"></asp:Label>
                            </td>
                            <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="TextBox5" runat="server" ErrorMessage="<%$ Resources:WebCharts, ValidationError_TextBox5 %>" ValidationExpression="^[1-9]\d*(\.\d+)?$"></asp:RegularExpressionValidator>
                </p>
            </td>
        </tr>
    </table>
