<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Labels_Titles_Tooltips_DataPoint_Labels_Default" %>
                ...
                <tr>
                    <td>
                        <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                            ...
                            <ScatterChart ColumnX="1" CharacterFont="Microsoft Sans Serif, 7.8pt" Icon="Random"
                                ...
                                IconSize="Auto" UseGroupByColumn="False">
                                <ChartText>
                                    <igchartprop:ChartTextAppearance Visible="False" ChartTextFont="Arial, 7pt" PositionFromRadius="50"
                                        Row="-2" ItemFormatString="&lt;DATA_VALUE:00.00&gt;" Column="-2" FontColor="Black"
                                        HorizontalAlign="Center" VerticalAlign="Center"></igchartprop:ChartTextAppearance>
                                </ChartText>
                            </ScatterChart>
                            ...
                            <Axis BackColor="Cornsilk">
                                ...
                                <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                                    RangeType="Automatic" TickmarkInterval="5" LineThickness="1" Extent="40" LogBase="10"
                                    RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10" NumericAxisType="Linear">
                                    <StripLines Interval="2" Visible="False">
                                        <PE FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill"
                                            Fill="Transparent" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit"
                    ...
                    <td valign="top">
                        <asp:CheckBox ID="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, DataPointLabels_CheckBox_1 %>"
