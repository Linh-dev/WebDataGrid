<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Labels_Titles_Tooltips_Series_Label_Rotation_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False" Version="5.3">
                    ...
                    <Axis BackColor="Cornsilk">
                        ...
                        <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            RangeType="Automatic" TickmarkInterval="0" LineThickness="1" Extent="100" LogBase="10"
            ...
            <td valign="top">
                <table id="Table1" cellspacing="1" cellpadding="1" border="0">
                    <tr>
                        <td>
                            <asp:Label ID="TableData1" runat="server" Text="<%$ Resources:WebCharts,SeriesLabelRotation_TableData_1 %>"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="TableData2" runat="server" Text="<%$ Resources:WebCharts,SeriesLabelRotation_TableData_2 %>"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="TableData3" runat="server" Text="<%$ Resources:WebCharts,SeriesLabelRotation_TableData_3 %>"></asp:Label>
                        </td>
                        <td>
