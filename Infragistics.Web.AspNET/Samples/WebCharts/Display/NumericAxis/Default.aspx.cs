...
public partial class Samples_WebCharts_Display_Numeric_Axis_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            string[] numericAxisType = System.Enum.GetNames(typeof(NumericAxisType));
            foreach (string s in numericAxisType)
            {
                this.DropDownList1.Items.Add(s);
            }

            this.DropDownList1.Items.FindByValue(System.Enum.GetName(typeof(NumericAxisType), this.UltraChart1.Axis.Y.NumericAxisType));
            this.WebNumericEdit1.ValueDouble = this.UltraChart1.Axis.Y.LogBase;
        }
    ...
    {
        this.UltraChart1.Axis.Y.NumericAxisType = (NumericAxisType)System.Enum.Parse(typeof(NumericAxisType), this.DropDownList1.SelectedItem.Value);
        this.UltraChart1.Axis.Y.LogBase = this.WebNumericEdit1.ValueDouble;
    }
}
