<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Numeric_Axis_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False"
                    ChartType="ColumnChart" Version="5.3">
                        ...
                        <Skin ApplyRowWise="False">
                            <PEs>
                                ...
                                <igchartprop:PaintElement FillGradientStyle="Horizontal" FillOpacity="255" FillStopOpacity="255"
                                    ...
                                    StrokeWidth="0" ImageWrapMode="Tile" TextureApplication="Normal">
                                </igchartprop:PaintElement>
                                <igchartprop:PaintElement FillGradientStyle="Horizontal" FillOpacity="255" FillStopOpacity="255"
            ...
            <td valign="top">
                <p>
                    <table id="Table2" cellspacing="1" cellpadding="1" border="0">
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, NumericAxes_Label1 %>"></asp:Label></td>
                            <td>
                        ...
                        <tr>
                            <td style="height: 17px">
                                <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, NumericAxes_Label2 %>"></asp:Label></td>
                            <td style="height: 17px">
                                <ig:WebNumericEditor ID="WebNumericEdit1" runat="server" Width="64px" MinValue="1.01" MaxValue="4000"></ig:WebNumericEditor>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" colspan="2">
                                <asp:Button ID="Button1" runat="server" Text="<%$ Resources:WebCharts, ThreeDScaling_UpdateChart %>"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </p>
