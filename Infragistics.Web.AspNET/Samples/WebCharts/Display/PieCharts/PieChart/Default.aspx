<%@ Page CodeFile="Default.aspx.cs" MasterPageFile="~/SamplePage.master" Language="c#" AutoEventWireup="false" Inherits="Samples_WebCharts_Display_Pie_Charts_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<igchart:UltraChart id="UltraChart1" runat="server" ChartType="PieChart">
		...
		<PieChart ConcentricSpacing="0.25" OthersCategoryPercent="3" BreakAlternatingSlices="False" BreakDistancePercentage="10" BreakOthersSlice="False" ColumnIndex="-1" Concentric="False" PieThickness="20" BreakAllSlices="False" StartAngle="0" OthersCategoryText="Others" RadiusFactor="90" ShowConcentricLegend="True">
