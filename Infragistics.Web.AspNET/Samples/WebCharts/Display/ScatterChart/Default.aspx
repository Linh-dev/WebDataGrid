<%@ Page CodeFile="Default.aspx.cs" MasterPageFile="~/SamplePage.master" Language="c#" AutoEventWireup="false" Inherits="Samples_WebCharts_Display_Scatter_Chart_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <P align="center">
	    <igchart:UltraChart id="UltraChart1" runat="server" ChartType="ScatterChart">
		    ...
		    <ScatterChart ColumnX="1" CharacterFont="Microsoft Sans Serif, 7.8pt" Icon="Random" ConnectWithLines="False" ColumnY="2" LineAppearance-DrawStyle="Solid" LineAppearance-SplineTension="0.3" LineAppearance-Thickness="3" NullHandling="Zero" GroupByColumn="0" Character="A" IconSize="Auto" UseGroupByColumn="False"></ScatterChart>
		    ...
		    <Axis BackColor="Cornsilk">
			    <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black" RangeType="Automatic" TickmarkInterval="20" LineThickness="1" Extent="40" LogBase="10" RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10" NumericAxisType="Linear">
			    ...
			    <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black" RangeType="Automatic" TickmarkInterval="5" LineThickness="1" Extent="40" LogBase="10" RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10" NumericAxisType="Linear">
				    <StripLines Interval="2" Visible="False">
					    <PE FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill" Fill="Transparent" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit" FillStopColor="Transparent" StrokeOpacity="255" ImagePath="" Stroke="Black" StrokeWidth="1" ImageWrapMode="Tile" TextureApplication="Normal"></PE>
				    </StripLines>
				    <ScrollScale Scale="1" Scroll="0" Height="10" Width="15" Visible="False"></ScrollScale>
				    <Labels ItemFormatString="&lt;DATA_VALUE:00.##&gt;" VerticalAlign="Center" WrapText="False" FontSizeBestFit="False" SeriesFormatString="" ClipText="True" Font="Verdana, 7pt" Flip="False" ItemFormat="DataValue" FontColor="Black" Orientation="VerticalLeftFacing" Visible="True" OrientationAngle="0" HorizontalAlign="Near">
