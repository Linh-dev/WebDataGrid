<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Series_Data_Minimum_Maximum_Data_Filtering_Default" %>
...
<TABLE id="Table1" cellSpacing="1" cellPadding="3" border="0">
					<TR>
						<TD>
							<igchart:UltraChart id="UltraChart1" runat="server" BackColor="White" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ForeColor="Black" ChartType="ColumnChart" EnableCrossHair="False" Version="5.3">
								...
								<Axis BackColor="Cornsilk">
									<Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black" RangeType="Automatic" TickmarkInterval="20" LineThickness="1" Extent="30" LogBase="10" RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10" NumericAxisType="Linear">
										...
										<Labels ItemFormatString="&lt;DATA_VALUE:00.##&gt;" VerticalAlign="Center" WrapText="False" FontSizeBestFit="False" SeriesFormatString="&lt;SERIES_LABEL&gt;" ClipText="True" Font="Verdana, 7pt" Flip="False" ItemFormat="DataValue" FontColor="Black" Orientation="Horizontal" Visible="True" OrientationAngle="0" HorizontalAlign="Far">
											<SeriesLabels Font="Microsoft Sans Serif, 7.8pt" Visible="True" HorizontalAlign="Center" FontSizeBestFit="False" ClipText="True" FormatString="&lt;SERIES_LABEL&gt;" Orientation="VerticalLeftFacing" WrapText="False" Flip="False" FontColor="Black" VerticalAlign="Center" OrientationAngle="0"></SeriesLabels>
										</Labels>
						...
						<TD vAlign="top">
							<TABLE id="Table2" cellSpacing="1" cellPadding="1" border="0">
								<TR>
									<TD colSpan="2">
										<asp:CheckBox id="CheckBox2" runat="server" Text="<%$ Resources:WebCharts, MinMaxRange2_Label1 %>"></asp:CheckBox></TD>
								</TR>
								<TR>
									<TD><asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, MinMaxRange2_Label2 %>"></asp:Label></TD>
									<TD>
										<ig:WebNumericEditor id="WebNumericEdit1" runat="server" Width="72px"></ig:WebNumericEditor></TD>
								</TR>
								<TR>
									<TD><asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, MinMaxRange2_Label3 %>"></asp:Label></TD>
									<TD>
										<ig:WebNumericEditor id="WebNumericEdit2" runat="server" Width="72px"></ig:WebNumericEditor></TD>
								</TR>
								<TR>
									<TD align="right" colSpan="2">
										<asp:Button id="Button1" runat="server" Text="<%$ Resources:WebCharts, EmptyDataStyle_Label7 %>"></asp:Button></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
