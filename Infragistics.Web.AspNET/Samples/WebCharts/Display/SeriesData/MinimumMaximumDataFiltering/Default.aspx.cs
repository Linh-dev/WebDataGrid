...
using System.Web.UI;
using WebSamplesCS;
public partial class Samples_WebCharts_Display_Series_Data_Minimum_Maximum_Data_Filtering_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.CheckBox2.Checked = this.UltraChart1.Data.UseMinMax;
        }
    }
    ...
    {
        this.UltraChart1.Data.UseMinMax = this.CheckBox2.Checked;
        this.UltraChart1.Data.MinValue = this.WebNumericEdit1.ValueDouble;
        this.UltraChart1.Data.MaxValue = this.WebNumericEdit2.ValueDouble;
    }
}