<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Series_Data_Null_Handling_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table id="Table1" cellspacing="1" cellpadding="3" border="0">
        <tr>
            ...
            <td valign="top">
                <p>
                    <asp:Label ID="Label10" runat="server" Text="<%$ Resources:WebCharts, ChartNullHandling_Label1 %>"></asp:Label></p>
                <p>
        ...
        <tr>
            <td colspan="2">
                <ig:WebDataGrid runat="server" ID="WebDataGrid1" Width="655px" Height="220px" DefaultColumnWidth="90px"/>
            </td>
        </tr>
    </table>
</asp:Content>
