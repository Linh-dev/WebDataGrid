<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Series_Data_Zero_Aligned_Axis_Default" %>
...
<TABLE id="Table1" cellSpacing="1" cellPadding="3" border="0">
					<TR>
						<TD>
							<igchart:UltraChart id="UltraChart1" runat="server" BackColor="White" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ForeColor="Black" EnableCrossHair="False" ChartType="LineChart" Version="5.3">
								...
								<Axis BackColor="Cornsilk">
									<Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black" RangeType="Automatic" TickmarkInterval="20" LineThickness="1" Extent="20" LogBase="10" RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10" NumericAxisType="Linear">
						...
						<TD vAlign="top">
							<asp:CheckBox id="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, ZeroAxisAlignment_Label1 %>" AutoPostBack="True"></asp:CheckBox></TD>
					</TR>
				</TABLE>
</asp:Content>
