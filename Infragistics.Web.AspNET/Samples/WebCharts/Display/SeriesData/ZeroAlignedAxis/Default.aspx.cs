...
public partial class Samples_WebCharts_Display_Series_Data_Zero_Aligned_Axis_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.CheckBox1.Checked = this.UltraChart1.Data.ZeroAligned;
        }

        this.UltraChart1.Data.ZeroAligned = this.CheckBox1.Checked;
    }
