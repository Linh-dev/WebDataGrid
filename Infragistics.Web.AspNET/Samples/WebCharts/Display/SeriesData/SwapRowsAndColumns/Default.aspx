<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Series_Data_Swap_Rows_And_Columns_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False" ChartType="ColumnChart3D"
                    Version="5.3" Transform3D-Perspective="50" Transform3D-ZRotation="0" Transform3D-Scale="50"
                    Transform3D-XRotation="144" Transform3D-YRotation="12" Height="500px">
                    ...
                    <Axis BackColor="Cornsilk">
                        <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                            ...
                            <Labels ItemFormatString="&lt;DATA_VALUE:00.##&gt;" VerticalAlign="Center" WrapText="False"
                                FontSizeBestFit="False" SeriesFormatString="" ClipText="True" Font="Microsoft Sans Serif, 7pt, style=Bold"
            ...
            <td valign="top">
                <p>
                    <asp:CheckBox ID="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, SwapRowsColumns_Label1 %>"
