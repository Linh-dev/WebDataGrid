...
public partial class Samples_WebCharts_Display_Series_Data_Swap_Rows_And_Columns_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        this.WebDataGrid1.DataSource = this.chartData1.BarColumnData;

        if (!Page.IsPostBack)
        {
            this.CheckBox1.Checked = this.UltraChart1.Data.SwapRowsAndColumns;
        }

        this.UltraChart1.Data.SwapRowsAndColumns = this.CheckBox1.Checked;
    }
