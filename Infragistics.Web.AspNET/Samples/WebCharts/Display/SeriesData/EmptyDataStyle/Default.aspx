<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Series_Data_Empty_Data_Style_Default" %>
						...
						<TD>
							<igchart:UltraChart id="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ForeColor="Black" BackColor="White" EnableCrossHair="False" ChartType="ColumnChart" Version="5.3" Transform3D-YRotation="12" Transform3D-XRotation="144" Transform3D-Scale="50" Transform3D-ZRotation="0">
								...
								<Data DataMember="" SwapRowsAndColumns="False" UseMinMax="False" UseRowLabelsColumn="False" MinValue="-1.7976931348623157E+308" RowLabelsColumn="-1" ZeroAligned="False" MaxValue="1.7976931348623157E+308">
									<EmptyStyle Text="Empty" EnableLineStyle="True" ShowInLegend="False" EnablePE="True" EnablePoint="True">
										...
										<PE FillGradientStyle="HorizontalBump" FillOpacity="255" FillStopOpacity="255" ElementType="Gradient" Fill="WhiteSmoke" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit" FillStopColor="Transparent" StrokeOpacity="255" ImagePath="" Stroke="Red" StrokeWidth="1" ImageWrapMode="Tile" TextureApplication="Normal"></PE>
									</EmptyStyle>
								</Data>
								...
								<Legend Font="Microsoft Sans Serif, 7.8pt" Visible="True" AlphaLevel="150" BorderThickness="1" BorderStyle="Solid" SpanPercentage="25" BorderColor="Navy" FontColor="Black" BackgroundColor="FloralWhite" DataAssociation="DefaultData" Location="Right" FormatString="&lt;ITEM_LABEL&gt;">
									<Margins Bottom="5" Left="5" Top="5" Right="5"></Margins>
								</Legend>
							...
							<TABLE id="Table2" cellSpacing="1" cellPadding="1" border="0">
								<TR>
									<TD colSpan="2" style="HEIGHT: 20px">
										<asp:CheckBox id="showInLegend" runat="server" Text="<%$ Resources:WebCharts, EmptyDataStyle_Label1 %>" Height="19px" Checked="True"></asp:CheckBox></TD>
								</TR>
								<TR>
									<TD colSpan="2">
										<asp:CheckBox id="enablePoint" runat="server" Text="<%$ Resources:WebCharts, EmptyDataStyle_Label2 %>" Height="19px" Checked="True"></asp:CheckBox></TD>
								</TR>
								<TR>
									<TD colSpan="2">
										<asp:CheckBox id="enablePE" runat="server" Text="<%$ Resources:WebCharts, EmptyDataStyle_Label3 %>" Checked="True"></asp:CheckBox></TD>
								</TR>
								<TR>
									<TD colSpan="2">
										<asp:CheckBox id="enableLineStyle" runat="server" Text="<%$ Resources:WebCharts, EmptyDataStyle_Label4 %>" Checked="True"></asp:CheckBox></TD>
								</TR>
								<TR>
									<TD><asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, EmptyDataStyle_Label5 %>"></asp:Label></TD>
									<TD>
										<asp:TextBox id="emptyTextEditor" runat="server" Width="128px">Empty</asp:TextBox></TD>
								</TR>
								<TR>
									<TD>
										<P><asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, EmptyDataStyle_Label6 %>"></asp:Label></P>
									</TD>
									<TD style="vertical-align : top;">
										<asp:DropDownList id="legendStyleEditor" runat="server"></asp:DropDownList></TD>
								</TR>
								<TR>
									<TD align="right" colSpan="2">
										<P>
											<asp:Button id="Button1" runat="server" Text="<%$ Resources:WebCharts, EmptyDataStyle_Label7 %>"></asp:Button></P>
									</TD>
								</TR>
							</TABLE>
						</TD>
