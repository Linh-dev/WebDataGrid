...
using WebSamplesCS;
public partial class Samples_WebCharts_Display_Line_And_Spline_Charts_Spline_Chart_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
