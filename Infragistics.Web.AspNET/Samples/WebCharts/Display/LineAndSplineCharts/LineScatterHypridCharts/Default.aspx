<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Line_And_Spline_Charts_Line_Scatter_Hyprid_Charts_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="ScatterLineChart">
        <Border CornerRadius="0" DrawStyle="Solid" Raised="False" Color="Black" Thickness="1">
        </Border>
        <ScatterLineChart Line-DrawStyle="Solid" Line-Thickness="3" Line-NullHandling="Zero"
            Line-MidPointAnchors="True" Line-StartStyle="DiamondAnchor" Line-HighLightLines="False"
            Line-EndStyle="DiamondAnchor" ScatterData-DataMember="" ScatterData-SwapRowsAndColumns="False"
            ScatterData-UseMinMax="False" ScatterData-UseRowLabelsColumn="False" ScatterData-MinValue="-1.7976931348623157E+308"
            ScatterData-RowLabelsColumn="-1" ScatterData-ZeroAligned="False" ScatterData-MaxValue="1.7976931348623157E+308"
            Scatter-ColumnX="1" Scatter-CharacterFont="Microsoft Sans Serif, 7.8pt" Scatter-Icon="Triangle"
            Scatter-ConnectWithLines="False" Scatter-ColumnY="2" Scatter-LineAppearance-DrawStyle="Solid"
            Scatter-LineAppearance-SplineTension="0.3" Scatter-LineAppearance-Thickness="3"
            Scatter-NullHandling="Zero" Scatter-GroupByColumn="0" Scatter-Character="A" Scatter-IconSize="Medium"
            Scatter-UseGroupByColumn="False" LineData-DataMember="" LineData-SwapRowsAndColumns="False"
            LineData-UseMinMax="False" LineData-UseRowLabelsColumn="False" LineData-MinValue="-1.7976931348623157E+308"
            LineData-RowLabelsColumn="-1" LineData-ZeroAligned="False" LineData-MaxValue="1.7976931348623157E+308">
        </ScatterLineChart>
            ...
            <Skin ApplyRowWise="False">
                <PEs>
                    ...
                    <igchartprop:PaintElement FillGradientStyle="Horizontal" FillOpacity="255" FillStopOpacity="255"
                        ...
                        StrokeWidth="1" ImageWrapMode="Tile" TextureApplication="Normal"></igchartprop:PaintElement>
                    <igchartprop:PaintElement FillGradientStyle="Horizontal" FillOpacity="255" FillStopOpacity="255"
        ...
        <Axis BackColor="Cornsilk">
            <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                RangeType="Automatic" TickmarkInterval="50" LineThickness="1" Extent="30" LogBase="10"
            ...
            <Y2 LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0"
                LineColor="Black" RangeType="Automatic" TickmarkInterval="20" LineThickness="1"
                Extent="30" LogBase="10" RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10"
