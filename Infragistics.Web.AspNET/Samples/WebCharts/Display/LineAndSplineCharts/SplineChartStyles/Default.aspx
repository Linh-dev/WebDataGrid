<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Line_And_Spline_Charts_Spline_Chart_Styles_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ForeColor="Black" BackColor="White" EnableCrossHair="False" ChartType="SplineChart"
                    Version="6.3">
            ...
            <td valign="top">
                <table>
                    <tr>
                        <td>
                            <ig:WebTab ID="WebTab1" runat="server" Width="280px" Height="249px">
                                <Tabs>
                                    <ig:ContentTabItem Key="Monday" Text="<%$ Resources:WebCharts, SplineChartStyles_Monday %>">
                                        <Template>
                                            <p>
                                            </p>
                                            <div style="display: inline; width: 110px; height: 26px" ms_positioning="FlowLayout">
                                                <p>
                                                    <asp:Label ID="Label5" runat="server" Text="<%$ Resources:WebCharts, SplineChartStyles_Label1 %>"></asp:Label></p>
                                            </div>
                                            <p>
                                                <ig:WebNumericEditor MaxValue="1.0" MinValue="0" ID="numSplineTensionMonday" runat="server">
                                                </ig:WebNumericEditor>
                                            </p>
                                        </Template>
                                    </ig:ContentTabItem>
                                    <ig:ContentTabItem Key="Tuesday" Text="<%$ Resources:WebCharts, SplineChartStyles_Tuesday %>">
                                        <Template>
                                            <p>
                                            </p>
                                            <div style="display: inline; width: 110px; height: 26px" ms_positioning="FlowLayout">
                                                <p>
                                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, SplineChartStyles_Label1 %>"></asp:Label></p>
                                            </div>
                                            <p>
                                                <ig:WebNumericEditor MaxValue="1.0" MinValue="0" ID="numSplineTensionTuesday" runat="server">
                                                </ig:WebNumericEditor>
                                            </p>
                                        </Template>
                                    </ig:ContentTabItem>
                                    <ig:ContentTabItem Key="Wednesday" Text="<%$ Resources:WebCharts, SplineChartStyles_Wednesday %>">
                                        <Template>
                                            <p>
                                            </p>
                                            <div style="display: inline; width: 110px; height: 26px" ms_positioning="FlowLayout">
                                                <p>
                                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, SplineChartStyles_Label1 %>"></asp:Label></p>
                                            </div>
                                            <p>
                                                <ig:WebNumericEditor MaxValue="1.0" MinValue="0" ID="numSplineTensionWednesday" runat="server">
                                                </ig:WebNumericEditor>
                                            </p>
                                        </Template>
                                    </ig:ContentTabItem>
