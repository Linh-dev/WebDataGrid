<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Bubble_And_Scatter_Charts_3D_Point_Chart_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="PointChart3D" Version="6.2">
        <Data>
            <EmptyStyle>
        ...
        <Axis>
            ...
            <Z Visible="True" LineThickness="1" TickmarkStyle="Smart">
                ...
                <Labels SeriesFormatString="&lt;SERIES_LABEL&gt;" ItemFormatString="&lt;DATA_VALUE:00.##&gt;"
                    VerticalAlign="Center" Visible="True" HorizontalAlign="Far" Font="Verdana, 7pt"
                    ItemFormat="DataValue" FontColor="DimGray" Orientation="Horizontal">
        ...
        <PointChart3D Icon="Cube" IconSize="Auto"></PointChart3D>
