<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Visual_Appearance_Data_Highlighting_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script type="text/javascript">
        function onMouseClick() { /* Do Nothing */ }
    </script>
</asp:Content>
                ...
                <tr>
                    <td>
                        <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                            ...
                            <ClientSideEvents ClientOnMouseClick="onMouseClick" />
                            ...
                            <DeploymentScenario Scenario="FileSystem" RenderingType="Flash" ImageURL="/SamplesBrowser/Temp/ChartImages/Chart_#SEQNUM(100).png"
                    ...
                    <td valign="top">
                        <asp:CheckBox ID="CheckBox1" runat="server" Width="160px" AutoPostBack="true" Text="<%$ Resources:WebCharts, Tracking_Label %>">
                        </asp:CheckBox>
                    </td>
                </tr>
            </table>
