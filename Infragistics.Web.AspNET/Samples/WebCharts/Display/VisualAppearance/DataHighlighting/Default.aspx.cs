...
public partial class Samples_WebCharts_Display_Visual_Appearance_Data_Highlighting_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.CheckBox1.Checked = this.UltraChart1.Tooltips.HotTrackingEnabled;
        }

        this.UltraChart1.Tooltips.HotTrackingEnabled = this.CheckBox1.Checked;
    }
