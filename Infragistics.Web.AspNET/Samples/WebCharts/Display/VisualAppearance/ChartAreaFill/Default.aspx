<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Visual_Appearance_Chart_Area_Fill_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table id="Table1" cellspacing="1" cellpadding="3" border="0">
        <tr>
            ...
            <td valign="top">
                <asp:Label ID="FillColor" runat="server" Text="<%$ Resources:WebCharts, AreaFill_FillColor %>"></asp:Label>
                <br />
                <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" />
                <br />
                <asp:CheckBox ID="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, AreaFill_3DChart %>"
