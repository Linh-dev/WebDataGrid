<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false" CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Visual_Appearance_Crosshairs_Default" %>
...
<TABLE id="Table1" cellSpacing="1" cellPadding="3" border="0">
					<TR>
						<TD>
							<igchart:UltraChart id="UltraChart1" runat="server" ChartImagesPath="/samplesbrowser/SamplesCommon/aspnet/WebCharts/Common/ChartImages" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource" ForeColor="Black" BackColor="White" EnableCrossHair="True" ChartType="ColumnChart" Version="5.3">
					...
					<ColorModel ColorBegin="DarkGoldenrod" ColorEnd="Navy" AlphaLevel="150" ModelStyle="CustomSkin" Grayscale="False" Scaling="None">
						...
						<TD vAlign="top">
							<P>
								<asp:CheckBox id="CheckBox1" runat="server" Text="<%$ Resources:WebCharts, CrossHairs_Label %>" AutoPostBack="True" Checked="True"></asp:CheckBox></P>
						</TD>
					</TR>
				</TABLE>
</asp:Content>
