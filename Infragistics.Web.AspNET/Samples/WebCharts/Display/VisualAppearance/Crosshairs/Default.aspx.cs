...
public partial class Samples_WebCharts_Display_Visual_Appearance_Crosshairs_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.CheckBox1.Checked = this.UltraChart1.EnableCrossHair;
        }

        this.UltraChart1.EnableCrossHair = this.CheckBox1.Checked;
    }
