...
public partial class Samples_WebCharts_Display_Visual_Appearance_Setting_Alpha_Levels_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.WebNumericEdit1.ValueByte = this.UltraChart1.ColorModel.AlphaLevel;
        }
    }
    ...
    {
        this.UltraChart1.ColorModel.AlphaLevel = this.WebNumericEdit1.ValueByte;
    }
}