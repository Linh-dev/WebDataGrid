...
public partial class Samples_WebCharts_Display_Visual_Appearance_Color_Model_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            string[] modelStyle = System.Enum.GetNames(typeof(ColorModels));
            foreach (string s in modelStyle)
            {
                this.DropDownList1.Items.Add(s);
            }
        }

        this.UltraChart1.ColorModel.ModelStyle = (ColorModels)System.Enum.Parse(typeof(ColorModels), this.DropDownList1.SelectedItem.Value);
    }
