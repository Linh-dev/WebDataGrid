<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Visual_Appearance_Color_Model_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <table id="Table1" cellspacing="1" cellpadding="3" border="0">
        <tr>
            ...
            <td valign="top">
                <p>
                    <asp:Label ID="Label11" runat="server" Text="<%$ Resources:WebCharts, ColorModel_Label1 %>"></asp:Label></p>
                <p>
