...
public partial class Samples_WebCharts_Display_Visual_Appearance_Background_Images_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            string[] backgroundImageStyles = System.Enum.GetNames(typeof(ImageFitStyle));
            foreach (string s in backgroundImageStyles)
            {
                this.DropDownList1.Items.Add(s);
            }

            this.DropDownList1.Items.FindByValue(System.Enum.GetName(typeof(ImageFitStyle), this.UltraChart1.BackgroundImageStyle)).Selected = true;
        }

        this.UltraChart1.BackgroundImageStyle = (ImageFitStyle)System.Enum.Parse(typeof(ImageFitStyle), this.DropDownList1.SelectedItem.Value);
        ...
        {
            case "StretchedFit":
                this.UltraChart1.BackgroundImageFileName = Server.MapPath("/SamplesBrowser/SamplesCommon/aspnet/WebCharts/Display/VisualAppearance/BackgroundImages/StretchedFit.png");
                break;

            case "Tiled":
                this.UltraChart1.BackgroundImageFileName = Server.MapPath("/SamplesBrowser/SamplesCommon/aspnet/WebCharts/Display/VisualAppearance/BackgroundImages/tileable.png");
                break;

            case "Centered":
                this.UltraChart1.BackgroundImageFileName = Server.MapPath("/SamplesBrowser/SamplesCommon/aspnet/WebCharts/Display/VisualAppearance/BackgroundImages/centered.png");
                break;
