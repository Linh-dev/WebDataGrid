<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Visual_Appearance_Background_Images_Default" %>
        ...
        <tr>
            <td>
                <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                    ...
                    Version="5.3" BackgroundImageStyle="Tiled" Width="408px" Height="304px">
            ...
            <td valign="top">
                <p>
                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, BackgroundImage_Label %>"></asp:Label></p>
                <p>
