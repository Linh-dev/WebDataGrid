<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Visual_Appearance_Gridlines_Default" %>
                ...
                <tr>
                        ...
                        <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                            ...
                            <Axis BackColor="Cornsilk">
                                <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                                    ...
                                    <MajorGridLines AlphaLevel="255" DrawStyle="Dot" Color="Black" Visible="True" Thickness="1">
                                    </MajorGridLines>
                                    <MinorGridLines AlphaLevel="255" DrawStyle="Dot" Color="Gray" Visible="False" Thickness="1">
                                    </MinorGridLines>
                    ...
                    <td valign="top">
                        <table id="Table1" cellspacing="1" cellpadding="1" border="0">
                            <tr>
                                <td>
                                    <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Text="<%$ Resources:WebCharts, GridLines_Label1 %>">
                                    </asp:CheckBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:CheckBox ID="CheckBox2" runat="server" AutoPostBack="True" Text="<%$ Resources:WebCharts, GridLines_Label2 %>">
                                    </asp:CheckBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:CheckBox ID="CheckBox3" runat="server" AutoPostBack="True" Text="<%$ Resources:WebCharts, GridLines_Label3 %>">
                                    </asp:CheckBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:CheckBox ID="CheckBox4" runat="server" AutoPostBack="True" Text="<%$ Resources:WebCharts, GridLines_Label4 %>">
                                    </asp:CheckBox>
                                </td>
                            </tr>
                        </table>
