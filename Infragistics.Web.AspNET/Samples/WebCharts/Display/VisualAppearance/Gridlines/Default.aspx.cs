...
public partial class Samples_WebCharts_Display_Visual_Appearance_Gridlines_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.CheckBox1.Checked = this.UltraChart1.Axis.X.MajorGridLines.Visible;
            this.CheckBox2.Checked = this.UltraChart1.Axis.X.MinorGridLines.Visible;
            this.CheckBox3.Checked = this.UltraChart1.Axis.Y.MajorGridLines.Visible;
            this.CheckBox4.Checked = this.UltraChart1.Axis.Y.MinorGridLines.Visible;
        }

        this.UltraChart1.Axis.X.MajorGridLines.Visible = this.CheckBox1.Checked;
        this.UltraChart1.Axis.X.MinorGridLines.Visible = this.CheckBox2.Checked;
        this.UltraChart1.Axis.Y.MajorGridLines.Visible = this.CheckBox3.Checked;
        this.UltraChart1.Axis.Y.MinorGridLines.Visible = this.CheckBox4.Checked;
