<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Statistical_Charts_Pareto_Chart_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="ParetoChart">
        ...
        <ParetoChart ColumnSpacing="0.5" NullHandling="Zero" LineLabel="Running Total" ShowLineInLegend="True">
            <LinePE FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill"
                Fill="Blue" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit" FillStopColor="Transparent"
                StrokeOpacity="255" ImagePath="" Stroke="Black" StrokeWidth="1" ImageWrapMode="Tile"
                TextureApplication="Normal"></LinePE>
            <LineStyle MidPointAnchors="True" EndStyle="RoundAnchor" DrawStyle="Solid" StartStyle="RoundAnchor">
            </LineStyle>
        </ParetoChart>
        <Axis BackColor="Cornsilk">
            ...
            <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                RangeType="Automatic" TickmarkInterval="0" LineThickness="1" Extent="30" LogBase="10"
