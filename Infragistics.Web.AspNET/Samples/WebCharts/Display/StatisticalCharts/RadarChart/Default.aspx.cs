...
public partial class Samples_WebCharts_Display_Statistical_Charts_Radar_Chart_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        this.UltraChart1.Data.DataSource = this.chartData1.RadarData;
    ...
    private void InitializeComponent()
    {
        ...
        // oleDbSelectCommand1
        // 
        this.oleDbSelectCommand1.CommandText = "SELECT [Crime Rate], [Death Rate], [Education Rate], Latitude, Longitude FROM Rad" +
            "arData";
        ...
        // oleDbInsertCommand1
        // 
        this.oleDbInsertCommand1.CommandText = "INSERT INTO RadarData([Crime Rate], [Death Rate], [Education Rate], Latitude, Lon" +
            "gitude) VALUES (?, ?, ?, ?, ?)";
        this.oleDbInsertCommand1.Connection = this.oleDbConnection1;
        this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Crime_Rate", System.Data.OleDb.OleDbType.Double, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(15)), ((System.Byte)(0)), "Crime Rate", System.Data.DataRowVersion.Current, null));
        this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Death_Rate", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "Death Rate", System.Data.DataRowVersion.Current, null));
        this.oleDbInsertCommand1.Parameters.Add(new System.Data.OleDb.OleDbParameter("Education_Rate", System.Data.OleDb.OleDbType.Integer, 0, System.Data.ParameterDirection.Input, false, ((System.Byte)(10)), ((System.Byte)(0)), "Education Rate", System.Data.DataRowVersion.Current, null));
        ...
        this.oleDbDataAdapter1.TableMappings.AddRange(new System.Data.Common.DataTableMapping[] {
																										new System.Data.Common.DataTableMapping("Table", "RadarData", new System.Data.Common.DataColumnMapping[] {
																																																					 new System.Data.Common.DataColumnMapping("Latitude", "Latitude"),
																																																					 new System.Data.Common.DataColumnMapping("Longitude", "Longitude"),
																																																					 new System.Data.Common.DataColumnMapping("Crime Rate", "Crime Rate"),
																																																					 new System.Data.Common.DataColumnMapping("Death Rate", "Death Rate"),
																																																					 new System.Data.Common.DataColumnMapping("Education Rate", "Education Rate")})});
        // 
        // chartData1
        // 
