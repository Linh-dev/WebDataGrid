<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Statistical_Charts_Probability_Chart_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="ProbabilityChart">
        ...
        <Axis BackColor="Cornsilk">
            ...
            <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                RangeType="Automatic" TickmarkInterval="5" LineThickness="1" Extent="80" LogBase="10"
                RangeMax="0" TickmarkStyle="Smart" TickmarkPercentage="10" NumericAxisType="Linear">
                <StripLines Interval="2" Visible="False">
                    <PE FillGradientStyle="None" FillOpacity="255" FillStopOpacity="255" ElementType="SolidFill"
                        Fill="Transparent" Hatch="None" Texture="LightGrain" ImageFitStyle="StretchedFit"
        ...
        <ProbabilityChart ColumnX="1" CharacterFont="Microsoft Sans Serif, 7.8pt" Icon="Random"
            ConnectWithLines="False" ColumnY="2" NullHandling="Zero" LineAppearance-DrawStyle="Solid"
            LineAppearance-SplineTension="0.3" LineAppearance-Thickness="3" Character="A"
            UseGroupByColumn="False" IconSize="Auto" GroupByColumn="0">
        </ProbabilityChart>
