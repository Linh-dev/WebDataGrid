...
public partial class Samples_WebCharts_Display_3D_Charting_Chart_Scaling_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.ScaleSlider.Value = this.UltraChart1.Transform3D.Scale;
        }
        this.UltraChart1.Transform3D.Scale = (float)this.ScaleSlider.ValueAsDouble;
    }
