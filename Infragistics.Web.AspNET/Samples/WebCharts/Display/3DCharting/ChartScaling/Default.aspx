<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_3D_Charting_Chart_Scaling_Default" %>
                ...
                <tr>
                    <td>
                        <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                            ForeColor="Black" ChartType="PieChart3D" BackColor="White" EnableCrossHair="False"
                            Version="5.3">
                    ...
                    <td valign="top">
                        <table id="Table2" cellspacing="1" cellpadding="1" border="0">
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, ThreeDScaling_ChartScale %>"></asp:Label>
                                    <ig:WebSlider ID="ScaleSlider" runat="server" Width="250px" MaxValueAsString="100"
