...
public partial class Samples_WebCharts_Display_3D_Charting_Chart_Rotation_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            this.XRotationSlider.Value = this.UltraChart1.Transform3D.XRotation;
            this.YRotationSlider.Value = this.UltraChart1.Transform3D.YRotation;
            this.ZRotationSlider.Value = this.UltraChart1.Transform3D.ZRotation;
        }

        this.UltraChart1.Transform3D.XRotation = (float)this.XRotationSlider.ValueAsDouble;
        this.UltraChart1.Transform3D.YRotation = (float)this.YRotationSlider.ValueAsDouble;
        this.UltraChart1.Transform3D.ZRotation = (float)this.ZRotationSlider.ValueAsDouble;
