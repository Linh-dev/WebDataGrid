<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Area_Charts_Area_Chart_Styles_Default" %>
                ...
                <tr>
                    <td>
                        <igchart:UltraChart ID="UltraChart1" runat="server" EmptyChartText="Data Not Available. Please call UltraChart.Data.DataBind() after setting valid Data.DataSource"
                            ForeColor="Black" ChartType="AreaChart" BackColor="White" EnableCrossHair="False"
                            Version="5.3">
                            ...
                            <Axis BackColor="Cornsilk">
                                ...
                                <X LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                                    RangeType="Automatic" TickmarkInterval="0" LineThickness="1" Extent="20" LogBase="10"
                            ...
                            <AreaChart LineDrawStyle="Solid" LineThickness="2" NullHandling="Zero" MidPointAnchors="True"
                                LineStartCapStyle="DiamondAnchor" LineEndCapStyle="DiamondAnchor">
                            </AreaChart>
                    ...
                    <td valign="top">
                        <table id="Table2" cellspacing="1" cellpadding="1" border="0">
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:WebCharts, AreaChartStyles_Label1 %>"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, AreaChartStyles_Label2 %>"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label4" runat="server" Text="<%$ Resources:WebCharts, AreaChartStyles_Label3 %>"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label6" runat="server" Text="<%$ Resources:WebCharts, AreaChartStyles_Label5 %>"></asp:Label>
                                </td>
                                <td>
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label5" runat="server" Text="<%$ Resources:WebCharts, AreaChartStyles_Label4 %>"></asp:Label>
                        <ig:WebSlider ID="ThicknessSlider" runat="server" Width="250px" MaxValueAsString="100"
