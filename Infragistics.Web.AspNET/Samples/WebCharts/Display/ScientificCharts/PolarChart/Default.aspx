<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Scientific_Charts_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="PolarChart">
        ...
        <PolarChart LabelFlippingEndAngle="145" LabelFlippingStartAngle="35" ColumnX="1"
            ColumnY="2" EnableLabelFlipping="True" LineAppearance-DrawStyle="Solid" LineAppearance-SplineTension="0.3"
            LineAppearance-Thickness="3" AngleUnit="Degrees" NullHandling="Zero" IconSize="Auto"
            CharacterFont="Microsoft Sans Serif, 7.8pt" UseGroupByColumn="True" Character="A"
            Icon="Random" GroupByColumn="0" FreeStandingAxis="True" FillArea="True">
        </PolarChart>
        <Axis BackColor="Cornsilk">
            <Y LineEndCapStyle="NoAnchor" LineDrawStyle="Solid" Visible="True" RangeMin="0" LineColor="Black"
                RangeType="Automatic" TickmarkInterval="50" LineThickness="1" Extent="40" LogBase="10"
