<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Legends_Legend_Locations_Default" %>
        ...
        <tr>
            ...
            <td valign="top">
                <table id="Table1" cellspacing="1" cellpadding="1" border="0">
                    <tr>
                        <td colspan="2">
                            <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Text="<%$ Resources:WebCharts, LegendLocation_ShowChartLegend %>"
                                Checked="True"></asp:CheckBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:WebCharts, LegendLocation_Position %>"></asp:Label>
                        </td>
                        <td>
