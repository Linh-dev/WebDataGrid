...
public partial class Samples_WebCharts_Display_Legends_Legend_Locations_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            string[] legendLocation = System.Enum.GetNames(typeof(LegendLocation));
            foreach (string s in legendLocation)
            {
                this.DropDownList1.Items.Add(s);
            }

            this.CheckBox1.Checked = this.UltraChart1.Legend.Visible;
        }

        this.UltraChart1.Legend.Visible = this.CheckBox1.Checked;
        this.UltraChart1.Legend.Location = (LegendLocation)System.Enum.Parse(typeof(LegendLocation), this.DropDownList1.SelectedItem.Value);
