...
public partial class Samples_WebCharts_Display_Composite_Charting_Composite_Legends_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void InsertCompositeChartLegends()
    {
        ...
        switch (this.Dropdownlist2.SelectedItem.Value)
        {
            case "Left":
                ...
                legend.Bounds = new Rectangle(0, 5, 20, 45);
            ...
            case "Right":
                legend.BoundsMeasureType = MeasureType.Percentage;
                legend.Bounds = new Rectangle(75, 5, 20, 45);
                this.UltraChart1.CompositeChart.ChartAreas[0].BoundsMeasureType = MeasureType.Percentage;
                this.UltraChart1.CompositeChart.ChartAreas[0].Bounds = new Rectangle(5, 0, 70, 100);
                break;
            case "Top":
                legend.BoundsMeasureType = MeasureType.Percentage;
                legend.Bounds = new Rectangle(25, 5, 65, 14);
                this.UltraChart1.CompositeChart.ChartAreas[0].BoundsMeasureType = MeasureType.Percentage;
                this.UltraChart1.CompositeChart.ChartAreas[0].Bounds = new Rectangle(0, 20, 100, 80);
                break;
            case "Bottom":
                legend.BoundsMeasureType = MeasureType.Percentage;
                legend.Bounds = new Rectangle(25, 70, 65, 14);
                this.UltraChart1.CompositeChart.ChartAreas[0].BoundsMeasureType = MeasureType.Percentage;
