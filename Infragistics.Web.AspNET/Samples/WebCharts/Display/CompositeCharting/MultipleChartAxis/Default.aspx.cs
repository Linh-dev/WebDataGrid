...
public partial class Samples_WebCharts_Display_Composite_Charting_Multiple_Chart_Axis_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        //Bind the appropriate data to each
        // numeric series in the composite chart
        n = (NumericSeries)this.UltraChart1.Series[0];
        n.Data.LabelColumn = "StockName";
        n.Data.ValueColumn = "Monday";
        n.Data.DataSource = this.chartData1.Tables["LineAreaData"];
        n.DataBind();

        n = (NumericSeries)this.UltraChart1.Series[1];
        n.Data.LabelColumn = "StockName";
        n.Data.ValueColumn = "Tuesday";
        n.Data.DataSource = this.chartData1.Tables["LineAreaData"];
        n.DataBind();

        n = (NumericSeries)this.UltraChart1.Series[2];
        n.Data.LabelColumn = "StockName";
        n.Data.ValueColumn = "Wednesday";
        n.Data.DataSource = this.chartData1.Tables["LineAreaData"];
        n.DataBind();

        n = (NumericSeries)this.UltraChart1.Series[3];
        n.Data.LabelColumn = "StockName";
        n.Data.ValueColumn = "Thursday";
        n.Data.DataSource = this.chartData1.Tables["LineAreaData"];
        n.DataBind();
    }
