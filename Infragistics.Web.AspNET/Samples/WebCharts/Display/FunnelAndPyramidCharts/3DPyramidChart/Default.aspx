<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Funnel_And_Pyramid_Charts_3D_Pyramid_Chart_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="PyramidChart3D" Width="400px"
        ...
        <PyramidChart3D Labels-Font="Microsoft Sans Serif, 7.8pt" Axis="HeightWithSlopeConstant">
        </PyramidChart3D>
