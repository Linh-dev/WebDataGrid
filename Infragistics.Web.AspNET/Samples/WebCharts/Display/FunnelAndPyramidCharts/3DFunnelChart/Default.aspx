<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="false"
    CodeFile="Default.aspx.cs" Inherits="Samples_WebCharts_Display_Funnel_And_Pyramid_Charts_3D_Funnel_Chart_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <p align="center">
        <igchart:UltraChart ID="UltraChart1" runat="server" ChartType="FunnelChart3D" Width="400px"
            Height="300px" Version="6.2">
            <FunnelChart3D Labels-Font="Microsoft Sans Serif, 7.8pt">
            </FunnelChart3D>
            <Data>
                <EmptyStyle>
            ...
            <Axis>
                ...
                <X LineEndCapStyle="Flat" Visible="True" TickmarkInterval="10" LineThickness="1"
                    ...
                    <ScrollScale Scale="1" Scroll="0"></ScrollScale>
                    <Labels SeriesFormatString="" ItemFormatString="&lt;DATA_VALUE:00.##&gt;" VerticalAlign="Near"
