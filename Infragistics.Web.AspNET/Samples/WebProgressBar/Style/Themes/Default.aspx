...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
  <div class="OptionPanel">
    ...
    <div style="width: 100%; padding: 20px; margin-top: 45px;">
        <div style="height: 20px">
            <img id="StyleImange" runat="server" src="/samplesbrowser/samplescommon/aspnet/WebProgressBar/Display/Themes/ThemeLabels/Default.png" /></div>
        <ig:WebProgressBar ID="WebProgressBar1" Value="63" runat="server" Width="200px" Height="25px"
            LabelAlignment="Center" StyleSetName="Default">
        </ig:WebProgressBar>
    </div>
</asp:Content>
