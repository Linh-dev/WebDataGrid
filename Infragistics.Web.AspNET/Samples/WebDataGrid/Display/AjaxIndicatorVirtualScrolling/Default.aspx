<%@ Page Title="" Language="C#" MasterPageFile="~/SamplePage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Samples_AjaxIndicator_Display_Using_VirtualScrolling_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  <style type="text/css">
        ...
        <div id="Div3" class="controlPanelEvent">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlFadeInEquationType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFadeInEquationType_SelectedIndexChanged" Width="120px">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlLocation" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlLocation_SelectedIndexChanged" Width="120px">
    ...
    <div id="DataGridWrapper">
       <ig:WebDataGrid ID="WebDataGridView" runat="server" AutoGenerateColumns="False" Height="370px"
            Width="100%">
            <AjaxIndicator Enabled="True" RelativeToControl="False" BlockArea="Page" BlockCssClass="ig_AjaxIndicatorBlock" />
            <Columns>
            ...
            <Behaviors>
                <ig:VirtualScrolling ScrollingMode="Deferred" DataFetchDelay="700" RowCacheFactor="1"
                    ThresholdFactor=".25" Enabled="true" VirtualScrollingClientEvents-MoreRowsRequesting="startCountDown" />
                <ig:Sorting SortingMode="Single" Enabled="true">
                    <SortingClientEvents ColumnSorting="startCountDown" />
                </ig:Sorting>
            </Behaviors>
        </ig:WebDataGrid>
    </div>
