...
public partial class Samples_WebDataGrid_Display_MultiColumnHeadersWithColumnFixing_Default : Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.Page.IsPostBack)
        {
            ...
            this.WebDataGridView.Behaviors.ColumnFixing.FixedColumns.Add(new FixedColumnInfo("SupCompanyInfo"));
        }
    }
}