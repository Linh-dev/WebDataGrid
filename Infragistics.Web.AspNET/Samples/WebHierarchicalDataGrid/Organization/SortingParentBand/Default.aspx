...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
  <div id="wrapper" class="wgDataBind">
        <div id="headerContainer" class="ControlPanelHeader">
            <img src="/samplesbrowser/samplescommon/aspnet/WebHierarchicalDataGrid/Organization/SortingParentBand/clientsideEvent.png" />
        ...
        <Columns>
            <ig:BoundDataField DataFieldName="SupplierID" Key="SupplierID" Header-Text="<%$ Resources:WebHierarchicalDataGrid ,WebHierarchicalDataGrid_HeaderText_SupplierID %>" Width="80px"/>
            ...
            <ig:BoundDataField DataFieldName="Region" Key="Region" Header-Text="<%$ Resources:WebHierarchicalDataGrid ,WebHierarchicalDataGrid_HeaderText_Region %>"  Width="100px"/>
        </Columns>
        <Bands>
        ...
        <Behaviors>
            ...
            <ig:Sorting SortingMode="Single" Enabled="true">
                ...
                <ColumnSettings>
                    <ig:SortingColumnSetting ColumnKey="Region" Sortable="false" />
                </ColumnSettings>
            </ig:Sorting>
