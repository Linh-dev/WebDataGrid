   ...
   <ig:WebDocumentExporter runat="server" ID="dExporter" ExportMode="Download" />
    <fieldset>
        ...
        <div>
            ...
            <asp:TextBox runat="server" ID="tbFileName" Text="WebHierarchicalDataGridExport"
    ...
    <fieldset style="width: auto; padding: 20px;">
        ...
        <ig:WebHierarchicalDataGrid ID="whdgProducts" runat="server" AutoGenerateColumns="false"
            DataSourceID="WebHierarchicalDataSource1" AutoGenerateBands="true"  StyleSetName="Appletini"
        ...
        <ig:WebHierarchicalDataGrid runat="server" ID="whdgEmpoyees" DataSourceID="whdsEmployees"
            DataKeyFields="EmployeeID" AutoGenerateColumns="true" Width="100%" Height="220" StyleSetName="RedPlanet"
            >
				<AjaxIndicator Enabled="False" />
        </ig:WebHierarchicalDataGrid>
    </fieldset>
