...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
   <div style="width: 100%">
        <ig:WebHierarchicalDataGrid ID="whdg1" runat="server" DataSourceID="WebHierarchicalDataSource1"
            InitialDataBindDepth="-1" AutoGenerateColumns="false" AutoGenerateBands="false"
            Height="400" Width="100%" DataKeyFields="EmployeeID">
            ...
            <Bands>
                <ig:Band DataMember="AccessDataSource2_Orders" Key="Orders" DataKeyFields="OrderID,CustomerID"
                    AutoGenerateColumns="false" ItemCssClass="OrdersItem" AltItemCssClass="OrdersAltItem"
                    HeaderCaptionCssClass="OrdersHeaderCaption">
                    <Columns>
                    ...
                    <Bands>
                        <ig:Band DataMember="AccessDataSource3_OrderDetails" Key="Details" AutoGenerateColumns="false"
                            DataKeyFields="ProductName" ItemCssClass="DetailsItem" AltItemCssClass="DetailsAltItem"
                            HeaderCaptionCssClass="DetailsHeaderCaption">
                            <Columns>
