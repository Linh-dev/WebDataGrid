...
public partial class Default :  Infragistics.Web.SampleBrowser.Core.Framework.Web.UI.ASPNET.SamplePage
{
    ...
    protected bool IsChecked
    {
        get {
            ...
            {
                return Convert.ToBoolean(Session["IsChecked"]);
            }
        }
        set { Session["IsChecked"] = value; }
    }
    ...
    protected void chkIsPersisted_CheckedChanged(object sender, EventArgs e)
    {
        IsChecked = ((CheckBox)sender).Checked;
    }
