...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <ig:WebDialogWindow runat="server" ID="WebDialogWindow1" Height="280px" Width="500px"
        ...
        <Header CloseBox-Visible="false" CaptionText="<%$ Resources:WebEditors, WebCurrencyEditorLocalizationName %>"
        ...
        <ContentPane ScrollBars="Hidden">
            <Template>
                <div style="padding: 20px;" class="css_form">
                    <label>
                        <%= this.GetGlobalResourceObject("WebEditors","WebCurrencyEditorLocalizationCulture") %></label>
                    <br />
                    <asp:DropDownList  ID="CultureList" runat="server" AutoPostBack="true"
                        OnSelectedIndexChanged="CultureList_SelectedIndexChanged" CssClass="CSSform">
                    ...
                    <br />
                    <label>
                        <%= this.GetGlobalResourceObject("WebEditors","WebCurrencyEditorLocalizationValue") %></label>
                    <br />
                    <ig:WebCurrencyEditor Height="18px" ID="CurrencyEditorLocalization" runat="server"
                        Culture="en-US" CssClass="CSSform" />
                    <br />
                </div>
            </Template>
        </ContentPane>
