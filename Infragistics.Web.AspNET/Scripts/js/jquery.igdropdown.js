(function ($) {
	...
	function CreateDropDown(source) {
		...
		//HACK: This fix is added, in order to fix the problem with zooming in/out in the browser. Having fixed width, control doesn't zoom properly
		customDropDown.css("width", "auto");
