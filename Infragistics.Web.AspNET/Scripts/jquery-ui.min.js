...
$.Widget.prototype.___super = function (args) {
	var baseMethod,
		prt = Object.getPrototypeOf(this.currentProt || {});

	while (prt && prt.widgetName) {
		baseMethod = prt[args.callee.name];
		if (baseMethod) {
			this.currentProt = prt;
...
$.Widget.prototype._super = function () {
	this.currentProt = this.currentProt || Object.getPrototypeOf(this);
	this.___super(arguments);
	delete this.currentProt;
};

$.Widget.prototype._superApply = function (args) {
	this.currentProt = this.currentProt || Object.getPrototypeOf(this);
	this.___super(args || arguments);
	delete this.currentProt;
};