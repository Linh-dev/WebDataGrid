...
/// <summary>
/// Summary description for DataCriteria
/// </summary>
public class DataCriteria
{

    private const string SQL_CRITERIABUIDLER_CONDITION_START = "(";
    private const string SQL_CRITERIABUIDLER_CONDITION_END = ")";
    private const string SQL_CRITERIABUIDLER_CONDITION_AND = " AND ";
    private const string SQL_CRITERIABUIDLER_CONDITION_OR = " OR ";
    private const string SQL_CRITERIABUIDLER_WHERE = " WHERE ";
    ...
    {
        this._whereClause.Append(DataCriteria.SQL_CRITERIABUIDLER_CONDITION_START);
    }

    public void EndFilter()
    {
        this._whereClause.Append(DataCriteria.SQL_CRITERIABUIDLER_CONDITION_END);
    }

    public void AddCondtionAnd()
    {
        this._whereClause.Append(DataCriteria.SQL_CRITERIABUIDLER_CONDITION_AND);
    }

    public void AddCondtionOr()
    {
        this._whereClause.Append(DataCriteria.SQL_CRITERIABUIDLER_CONDITION_OR);
    }
