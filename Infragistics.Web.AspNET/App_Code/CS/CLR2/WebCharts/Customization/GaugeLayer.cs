		...
		public void FillSceneGraph(SceneGraph scene)
		{
			...
			if (_Appearance!= null && YApp != null) 
			{
				...
				foreach(GaugeSection sec in this._Appearance.Sections) 
				{
					...
					w.PE = sec.PE;
					w.RadiusInner = sec.StartWidth*this._Appearance.Radius/100;
					scene.Add(w);
				...
				while(d_i< (double)_Ruler.WindowMaximum + 2* double.Epsilon + delta) 
				{
					...
					if (YApp.MajorGridLines.Visible) 
					{
						...
						Point p1 = Infragistics.UltraChart.Core.Layers.Axis.angularToCartesian(this._Appearance.Center, r1, -Wedge.DegToRadians(ang));
						Point p2 = Infragistics.UltraChart.Core.Layers.Axis.angularToCartesian(this._Appearance.Center, r2, -Wedge.DegToRadians(ang));
					...
					if (YApp.MinorGridLines.Visible) 
					{
						if (d_i+delta/2 < (double)_Ruler.WindowMaximum ) 
						{
							...
							Point p1 = Infragistics.UltraChart.Core.Layers.Axis.angularToCartesian(this._Appearance.Center, r1+tfp, -Wedge.DegToRadians(ang1));
							Point p2 = Infragistics.UltraChart.Core.Layers.Axis.angularToCartesian(this._Appearance.Center, r2-tfp, -Wedge.DegToRadians(ang1));
					...
					if (YApp.Labels.Visible) 
					{
						...
						Point p3 = Infragistics.UltraChart.Core.Layers.Axis.angularToCartesian(this._Appearance.Center, r3, -Wedge.DegToRadians(ang));
				...
				for(int i =0; i <this.Appearance.Needles.Count; i++) 
				{
					...
					Point p = Infragistics.UltraChart.Core.Layers.Axis.angularToCartesian(this._Appearance.Center, nd.Length*this._Appearance.Radius/100, Wedge.DegToRadians( - theta_i));
